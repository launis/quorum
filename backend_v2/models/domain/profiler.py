...
class TextMetrics(V2CoreBase):
    ...
    sentence_count: Annotated[
        int, Field(description="Total sentence count.", json_schema_extra={"x-ui-label": "Sentence Count"})
    ]
    avg_sentence_length: Annotated[
        float, Field(description="Average words per sentence.", json_schema_extra={"x-ui-label": "Avg Sentence Length"})
    ]
    lexical_diversity: Annotated[
        float, Field(description="Unique words / total words.", json_schema_extra={"x-ui-label": "Lexical Diversity"})
    ]
    ...
    control_ratio: Annotated[
        float, Field(description="User/AI token ratio.", json_schema_extra={"x-ui-label": "Control Ratio"})
    ] = 0.0
...
class BehavioralMetrics(V2CoreBase):
    ...
    automation_bias: Annotated[
        float, Field(description="Over-reliance on AI.", json_schema_extra={"x-ui-label": "Automation Bias"})
    ] = 0.0
    illusion_of_competence: Annotated[
        float,
        Field(
...
class ProfilerInput(V2CoreBase):
    ...
    profiler_metrics: Annotated[ProfilerMetrics | None, Field(description="Injected text metrics.")] = None
