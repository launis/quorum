...
class ExecutionCreate(V2CoreBase):
    ...
    target_locale: str = Field(
        description="Desired target locale for output generated by the workflow (e.g., 'fi'). Must be explicitly provided."
    )
...
class ExecutionRecord(V2CoreBase):
    ...
    metadata: dict[str, Any] = Field(
        default_factory=dict,
        description="Arbitrary metadata for the execution, e.g. macro and micro strictness levels"
    )
