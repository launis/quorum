...
class WorkflowState(V2CoreBase):
    ...
    def start_time(self) -> datetime:
        """Get the starting timestamp of this workflow."""
    ...
    @property
    def step_detector(self) -> PerformativityOutput | None:
        return self.get_context("step_detector", PerformativityOutput)

    @property
    def step_judge_cognitive(self) -> JudgeOutput | None:
...
class StateProjector:
    ...
    def snapshot(self) -> list[StepOutputDTO]:
        """Returns the current flattened read model as a strictly typed list of StepOutputDTOs."""
