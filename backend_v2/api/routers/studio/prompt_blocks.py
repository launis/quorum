...
@router.get("/by-slug/{slug}", response_model=PromptBlock)
async def get_prompt_block_by_slug(slug: str, current_user: CurrentUserDep, studio_service: StudioServiceDep) -> PromptBlock:
