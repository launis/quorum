...
@pytest.mark.asyncio
async def test_vertex_adapter_caching_system_role_bug():
    ...
    with patch("backend_v2.llm.adapters.vertex_adapter.get_redis_client", new_callable=AsyncMock) as mock_redis, \
