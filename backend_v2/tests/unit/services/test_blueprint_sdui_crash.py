...
async def test_blueprint_authenticity_evaluation_crash() -> None:
    ...
    mock_profile_dict = {
        ...
        "workflow_id": "wf_1234567812345678",
        "metric_mappings": {
            "jargon_score": {"default_locale": "en", "translations": {"en": "Jargon Score"}},
            "authenticity_level": {"default_locale": "en", "translations": {"en": "Authenticity Evaluation"}},
            ...
            "authenticity_fallback_explanation": {"default_locale": "en", "translations": {"en": "Fallback"}},
        },
        "layouts": [],
