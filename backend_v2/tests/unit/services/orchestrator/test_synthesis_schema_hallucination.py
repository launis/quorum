...
async def test_synthesis_schema_hallucination_repro():
    ...
    mock_response = {
        ...
        "eval_1": {"section_syntheses": [{"section_name": "Johdanto", "summary": "Test summary"}]},
    }
    ...
    long_test_payload = (
        "This is a very long test payload that satisfies the fail-fast length check of the executor. " * 50
    )
