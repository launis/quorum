...
def schema_factory() -> SchemaFactory:
    return SchemaFactory(resolve_i18n_fn=lambda lbl, loc: "Sample I18N")
...
def test_schema_matrix_bug_repro(schema_factory: SchemaFactory) -> None:
    ...
    criteria = [
        PromptBlockAdapter.validate_python(protocol_block_raw),
        PromptBlockAdapter.validate_python(matrix_block_raw),
    ]
