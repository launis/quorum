...
def test_mcp_source_id_literal_validation() -> None:
    ...
    Schema = factory.build_dynamic_schema(
        ...
        allowed_atom_ids=["a0"],
        allowed_dynamic_keys=["chat_log"],
        allowed_mcp_prefixes=["tavily_"],
    )
    ...
    payload = {
        "blk_0123456789abcdef0123456789abcdef": {
            ...
            "exact_quotes": [{"source_id": "tavily_ff768d39", "text": "This is a fact checked from tavily."}],
    ...
    # 4. This should pass because the schema should allow tavily_ prefix for tool results
    validated = Schema.model_validate(payload)
    assert (
        validated.model_dump()["blk_0123456789abcdef0123456789abcdef"]["exact_quotes"][0]["source_id"]
        == "tavily_ff768d39"
    )
