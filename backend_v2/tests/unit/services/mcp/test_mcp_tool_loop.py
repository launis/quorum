...
async def test_tool_loop_no_tools_passthrough() -> None:
    ...
    # execute_chat_task should NOT be called when no tools
    executor.execute_chat_task.assert_not_called()
...
async def test_tool_call_id_preserved_from_llm() -> None:
    ...
    call_args = mock_executor.execute_structured_task.call_args
