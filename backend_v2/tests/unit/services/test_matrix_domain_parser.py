...
from backend_v2.models.v2_core import PromptBlock, I18nText, MatrixScale, OutputProfile, MatrixClaim, TDAAssertion
            ...
            MatrixScale(
                ...
                claims=[
                    MatrixClaim(
                        ...
                        ai_description="Desc",
                        tda_assertions=[TDAAssertion(inverse_evidence=False, aggregation_mode="EXISTS", concept_description="test concept")]
                    )
                ]
            ),
            MatrixScale(
