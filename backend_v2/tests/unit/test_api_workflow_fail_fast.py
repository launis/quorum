...
def test_workflow_api_strips_illegal_step_attributes(client_admin: Any, mock_studio_service_admin: Any) -> None:
    ...
    assert not mock_studio_service_admin.save_workflow.called


def test_prompt_block_api_fails_fast_on_invalid_type(client_admin: Any) -> None:
...
def test_step_api_fails_fast_on_invalid_extra_attributes(client_admin: Any) -> None:
...
def test_workflow_api_succeeds_with_valid_data(client_admin: Any, mock_studio_service_admin: Any) -> None:
    ...
    assert mock_studio_service_admin.save_workflow.called
