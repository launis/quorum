...
def test_anthropic_precision_calculation_scenarios() -> None:
    ...
    usage_with_creation = AnthropicTokenUsage(
        prompt_tokens=1000, completion_tokens=500, cache_creation_input_tokens=800
    )
    ...
    usage_with_reads = TokenUsage(prompt_tokens=1000, completion_tokens=500, cached_tokens=600)
