...
def test_bug_metric_mappings_silent_override():
    ...
    db_profile = OutputProfile(
        ...
        metric_mappings={"variance_mechanical": {"default_locale": "en", "translations": {"en": "Mech"}}}
    )
    ...
    # THE BUG: The saved profile should NOT have lost variance_mechanical!
    assert "variance_mechanical" in saved_profile.metric_mappings, "Bug Reproduced: variance_mechanical was deleted during merge!"
