...
from backend_v2.exceptions import AppException, ErrorCodes, ConfigurationError
...
async def test_render_execution_fails_fast_on_corrupt_pdf(
    ...
    mock_repo.get_workflow_by_id = AsyncMock(return_value={
        ...
        "organization_id": "org_1",
        "name": "wf",
        "output_profiles": {"default": {"name": {"default_locale": "en", "translations": {"en": "Default Profile"}}}}
    })
