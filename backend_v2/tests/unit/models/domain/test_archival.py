...
def test_archival_precedent_dto_validation() -> None:
    ...
    dto = ArchivalPrecedentDTO(id="arc_123", date="2026-05-04", scores="5.0", verdict="Approved")
    ...
    with pytest.raises(ValidationError):
        ArchivalPrecedentDTO.model_validate(
            {
                "id": "arc_123",
                "date": "2026-05-04",
                "scores": "5.0",
    ...
    # Test missing fields
    with pytest.raises(ValidationError):
        ArchivalPrecedentDTO.model_validate({"id": "arc_123", "date": "2026-05-04", "scores": "5.0"})
