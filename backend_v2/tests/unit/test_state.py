...
from backend_v2.models.state import StateProjector, TraceEvent, TombstoneEvent
...
def test_state_projector_fail_fast_on_legacy_data() -> None:
    ...
    projector._snapshot["stp_legacy"] = "I am a raw string output from V1" # type: ignore
