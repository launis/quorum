...
async def test_vertex_adapter_caching_name_format_bug():
    ...
    with patch.dict(os.environ, {"VERTEX_PROJECT_ID": "cognitive-quorum"}), \
        ...
        assert kwargs["cached_content"] == "projects/cognitive-quorum/locations/europe-north1/cachedContents/1317893878505799680", "Cache ID was not fully qualified!"
