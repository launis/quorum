...
# Models / Services
from backend.models.auth import User, UserRole, Organization, OrganizationCreate, UserCreate
...
async def run_verification():
    ...
    # 2. Setup Org & Data
    org_create = OrganizationCreate(name="DeleteMe Corp", admin_email="admin@deleteme.com", admin_password="password123", admin_name="Admin")
