...
def execute_google_search(state: WorkflowState) -> WorkflowState:
    ...
    Logic (Fail Fast):
    1. Extracts 'step_analyst' data. If missing, logs warning and returns (safe default for optional step).
    ...
    # 4. Initialize Tool (Fails Fast on Config Error - Let it Bubble Up)
