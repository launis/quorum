...
class TokenUsage(BaseModel):
    ...
    cached_tokens: int = Field(default=0, description="Tokens retrieved from cache.", json_schema_extra={"x-ui-label": "Cached Tokens"})
    reasoning_tokens: int = Field(default=0, description="Tokens used for reasoning/thought generation.", json_schema_extra={"x-ui-label": "Reasoning Tokens"})
