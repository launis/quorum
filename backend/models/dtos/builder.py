...
class StepDTO(BaseModel):
    ...
    # Allow extra fields for flexibility (e.g. fusion_info)
...
class StepPreviewResponse(BaseModel):
    ...
    system_instruction: str = Field(..., description="The full system prompt.", json_schema_extra={"x-ui-label": "System Instruction"})
    user_prompt: str = Field(..., description="The user prompt template logic.", json_schema_extra={"x-ui-label": "User Prompt"})
...
class ChainPreviewResponse(BaseModel):
    ...
    markdown_content: str = Field(..., description="The full Markdown concatenation of all step prompts.", json_schema_extra={"x-ui-label": "Chain Content"})
