...
class XAIFlatReportDTO(BaseDTO):
    ...
    # Key Drivers
    top_strength_id: Optional[str] = Field(None, description="ID of the highest scoring dimension.")
    top_weakness_id: Optional[str] = Field(None, description="ID of the lowest scoring dimension.")
    ...
    flattened_scores: Dict[str, float] = Field(
        ...
        description="Key-value map of dimension IDs to their numeric scores."
    )
