...
def test_passivity_legacy_dict_accepted(mock_state):
    ...
    valid_judge_dict = {
        ...
        "score_card": {
            ...
            "scale_min": 1.0,
            "scale_max": 5.0,
            "dimensions": [{"dimension_id": "d1", "score": 1.0, "reasoning": "bad"}],
        },
    }

    state = mock_state.model_copy(update={"context_variables": {"step_judge": valid_judge_dict}})
