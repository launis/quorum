...
target_files = ["test_builder_preview.py", "test_builder_workflows.py", "test_organizations.py", "test_llm_router.py"]
...
if __name__ == "__main__":
    ...
    for root, _dirs, files in os.walk("backend/tests/core"):
        for file in files:
            if file.startswith("test_") and file.endswith(".py"):
