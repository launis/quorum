...
from backend.models.dtos.execution import ExecutionRequestDTO, Base64FileDTO
...
from backend.dependencies import get_current_user_from_header, get_arq_pool, get_async_repository
...
def test_execution_creation_pipeline_files(mock_document_service):
    ...
    from backend.dependencies import get_async_repository, get_engine, get_document_service_dep
    mock_repo = AsyncMock()
    mock_def = AsyncMock()
