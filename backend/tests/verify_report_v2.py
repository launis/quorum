...
from backend.models.domain import (
    XAIReport, CoachingPlan, EtiikkaJaFakta, EettinenHavainto, 
    TuomioJaPisteet, MestaruusPoikkeama, AitousEpaily, Pisteet, PisteetKriteeri
)
...
def get_base_fields():
    return {
        "metadata": {
            "luontiaika": "2026-01-15T12:00:00Z",
            "agentti": "TestAgent",
            "vaihe": 1,
            "versio": "2.0"
        },
    ...
    state = WorkflowState(
        ...
        step_judge=TuomioJaPisteet(
            **base,
            ...
            pisteet=Pisteet(
                analyysi=PisteetKriteeri(arvosana=3, perustelu="Good")
            ),
