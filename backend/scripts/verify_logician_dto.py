...
import asyncio
import logging
from backend.models.domain.logician import LogicianOutput, LogicianOutputDTO, LogicianData, ToulminComponent, CognitiveLevel, WaltonScheme
    ...
    dto_data = {
        ...
        "logician_data": {
            ...
            "walton_scheme": {
                ...
                "critical_questions": ["Is he an expert?"]
            },
            "toulmin_score": 5.0
        }
    }
    
    dto = LogicianOutputDTO(**dto_data)
