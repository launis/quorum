...
async def test_coach_fail():
    ...
    try:
        ...
        await agent.execute(input_data={"history_text": "foo"}, execution_context={})  # type: ignore[arg-type]
...
async def test_judge_fail():
    ...
    try:
        ...
        await agent.execute(input_data={"product_text": "foo"}, execution_context={})  # type: ignore[arg-type]
...
async def test_logician_fail():
    ...
    try:
        ...
        await agent.execute(input_data={}, execution_context={})  # type: ignore[arg-type]
...
async def test_profiler_fail():
    ...
    try:
        ...
        await agent.execute(input_data=none_input, execution_context={}, system_instruction="Test")  # type: ignore[arg-type]
    ...
    try:
        await agent.execute(input_data={"product_text": "p"}, execution_context={}, system_instruction="Test")  # type: ignore[arg-type]
...
async def test_guard_fail():
    ...
    try:
        agent = GuardAgent(model="gpt-4o-mini", provider="openai")
        await agent.execute(input_data={}, execution_context={}, system_instruction="Test")  # type: ignore[arg-type]
...
async def test_analyst_fail():
    ...
    try:
        ...
        await agent.execute(input_data=short_inputs, execution_context={}, system_instruction="Test")  # type: ignore[arg-type]
...
async def test_xai_fail():
    ...
    try:
        ...
        empty_input: dict[str, str] = {}
        await agent.execute(input_data=empty_input, execution_context={})  # type: ignore[arg-type]
    ...
    try:
        ...
        await agent.execute(input_data=bad_input, execution_context={})  # type: ignore[arg-type]
...
async def test_critics_fail():
    ...
    for AgentClass, name in agents:
        try:
            ...
            await agent.execute(input_data={}, execution_context={})  # type: ignore[arg-type, attr-defined]
