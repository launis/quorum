            ...
            if orgs:
                ...
                st.dataframe(
                    ...
                    column_config={
                        ...
                        "subscription_status": st.column_config.SelectboxColumn("Status", options=["active", "past_due", "canceled", "trial"]),
        ...
        try:
            ...
            if current_settings:
                with st.form("global_settings_form"):
                    ...
                    with col_a:
                        m_mode = st.checkbox("Maintenance Mode", value=current_settings.get("maintenance_mode", False), help="Only ROOT admins can login.")
                        signups = st.checkbox("Allow New Signups", value=current_settings.get("allow_signups", True))
                        beta = st.checkbox("Enable Beta Features", value=current_settings.get("enable_beta_features", False))
                    ...
                    with col_b:
                        ...
                        banner = st.text_input("Global Announcement Banner", value=current_settings.get("global_banner") or "")
    ...
    with tabs[2]:
        ...
        if submitted:
            try:
                ...
                if filter_org: params["organization_id"] = filter_org
                if filter_actor: params["actor_uid"] = filter_actor
                if filter_action: params["action"] = filter_action
