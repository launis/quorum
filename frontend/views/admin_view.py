...
def render_admin_view(api_client, backend_url, workflow_options):
    """
    Renders the Admin / Tooling dashboard.
    Restored to full functionality matching original ui.py.
    """
    ...
    with tabs[1]:
        ...
        def_idx = 0
        if "ui_selected_workflow_id" in st.session_state and st.session_state["ui_selected_workflow_id"] in workflow_options:
