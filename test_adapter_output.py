...
layout = OutputLayoutBlock(preset_view='text_only', title=I18nText(default_locale='en', translations={'en': 'Test'}), target_blocks=[], text_delivery_mode='none')
profile = OutputProfile(id='prf_1234567890abcdef', slug='test', workflow_id='test', name=I18nText(default_locale='en', translations={'en': 'Test'}), layouts=[layout])
