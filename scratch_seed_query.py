...
for i, block in enumerate(seed.get("prompt_blocks", [])):
    ...
    if (
        "strategia" in name.lower()
        or "päättely" in instructions.lower()
        or "tiedolla" in name.lower()
        or "epäsuora" in instructions.lower()
        or "kulttuuri" in name.lower()
        or "ilmapiiri" in name.lower()
        or "sitoutuminen" in name.lower()
        or "arvot" in name.lower()
        or "valmius" in name.lower()
    ):
