...
- [x] Phase 3, Step 3.1 (`universal_fail_fast`): Fail-Fast if inputs are invalid or profile cannot be resolved.
- [x] Phase 3, Step 3.2 (`quality_gate_execution`): Run backend audit loop on modified tests.
...
- [x] **Phase 3: Execution Service Integration**
  - [x] Step 3.1: Integrate Resolver in `ExecutionService.start_execution` (`backend_v2/services/execution.py`)
  - [x] Step 3.2: Unit Test Execution Service Integration (`backend_v2/tests/unit/services/test_execution.py`)
