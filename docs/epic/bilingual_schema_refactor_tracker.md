...
- [NOK] `phase2_best_of_three_routing.md` - Best-of-3 Routing & Execution (Jälki-Epic C)
- [NOK] `phase3_db_migration_offline.md` - Offline DB ETL Migration Script
- [NOK] `phase4_backend_schema_update.md` - Backend Pydantic Schema & Atomic Commit
- [NOK] `phase5_frontend_schema_ui.md` - Frontend DTO Sync & Admin UI
