...
- [x] `docs/epic/tasks_system2_variance_analysis_report/phase1_contested_revitalization.md` - CONTESTED-tilan elvytys ja matemaattinen korjaus
- [x] `docs/epic/tasks_system2_variance_analysis_report/phase2_dynamic_penalty_and_safety_lock.md` - Kaksiportainen turvalukko ja dynaaminen sakko
- [x] `docs/epic/tasks_system2_variance_analysis_report/phase3_cognitive_unlock_and_cot.md` - Kognitiivinen purkutila ja tuplainversio-ansan eliminointi
- [x] `docs/epic/tasks_system2_variance_analysis_report/phase4_seed_data_updates.md` - Binäärilukko ja Arkkitehtuurinen Jitter (Seed Data)
