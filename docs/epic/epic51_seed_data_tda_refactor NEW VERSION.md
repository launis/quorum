...
Epic 52:n jälkeen suoritettu ristiinajotestaus paljasti yhä **18.9 % haamuvarianssia** kahden identtisen ajon välillä. Tämä johtui yksinomaan siitä, että tekoäly joutui tulkitsemaan subjektiivisia laatusanoja tai sekoitti käyttäjän ja tekoälyn roolit. Tästä syystä tämä Epic nojaa ehdottomaan Zero-Interpretation \-doktriiniin: Sääntöjä on käsiteltävä ikään kuin ne olisivat säännöllisiä lausekkeita (Regex). Kielimallilta EVÄTÄÄN oikeus tulkita, ja sille annetaan vain oikeus suorittaa tarkka "If-This-Then-That" \-tarkistuslista.
...
* Determinismi-aste ylittää 95,0 % ristiinajoissa.  
...
### **Osa B: Zero-Interpretation ja Roolit (V4-Kovetus)**

6. **Sääntö 6: Subjektiivisten adjektiivien kielto (The Ban of Subjectivity):** Laatusanat (robusti, hyvä, mestarillinen) on EHDOTTOMASTI kielletty. Korvaa ne määrällisillä kynnyksillä (esim. "vähintään 3 askelta").  
...
10. **Sääntö 10: Leksikaaliset indikaattorit (Lexical Proxies):** Abstraktit konseptit on ankkuroitava fyysisiin siirtymäsanoihin (esim. 'however', 'therefore').  
11. **Sääntö 11: Imperatiivinen käskymuoto (Actionable Directives):** Mikrotason sääntö ei saa olla kysymys. Sen on alettava toimintaverbillä (Identify, Locate, Extract).
...
* \[ \] **5\. Subjektiivisuuden kielto:** Laatusanojen korvaaminen kynnyksillä.  
* \[ \] **6\. Rooliautentikointi:** Roolien ankkurointi (user:/ai:).  
* \[ \] **7\. Sanasto ja Laiskuus:** Indikaattorit, Anti-Proxies ja Bounding Boxit.  
* \[ \] **8\. Opaque ID & Aggregaatio:** Satunnaiset heksat ja EXISTS-tila.  
* \[ \] **9\. 100 % Kattavuus:** Vahvistus kaikkien pisteiden (1–5) käsittelystä.  
* \[ \] **10\. Auditointi-varmistus:** Vahvistus, että scripts\\backend\_audit\_loop.py on ajettu generoidulle skriptille onnistuneesti.
