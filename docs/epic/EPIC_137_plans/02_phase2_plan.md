...
<action>Delete corresponding dead tests and stale mock references from `@[c:\src\quorum\backend_v2\tests\unit\services\orchestrator\test_prompt_compiler_adapter.py]`, `@[c:\src\quorum\backend_v2\tests\unit\services\orchestrator\test_localization_compiler.py]`, `@[c:\src\quorum\backend_v2\tests\unit\services\orchestrator\strategies\test_prompt_compiler_schema_strictness.py]`, `@[c:\src\quorum\backend_v2\tests\integration\test_prompt_compiler.py]`, and `@[c:\src\quorum\backend_v2\tests\unit\test_dag_executor_prompt_blocks.py]`.</action>
<action>Remove unused import `EvaluationMandate` from `@[c:\src\quorum\backend_v2\services\orchestrator\localization_compiler.py]` to prevent Ruff F401 crash.</action>
<action>Remove unused import `GLOBAL_MANDATES_XML` from `@[c:\src\quorum\backend_v2\services\orchestrator\prompt_compiler_adapter.py]` to prevent Ruff F401 crash.</action>
