...
def test_metrics_hooks_exist():
    ...
    from backend.hooks.metrics import calculate_control_ratio_hook, calculate_text_metrics_hook
...
def test_security_hooks_exist():
    ...
    from backend.hooks.security import check_banned_phrases_hook, sanitize_text_hook
