...
def dummy_atoms():
    return [
        ExtractedAtom(
            reasoning="R1", resolved_claim="Claim 1", source_quote="Q1", tda_id="tda_1111111111111111", source_id="chunk_0"
        ),
        ExtractedAtom(
            reasoning="R2", resolved_claim="Claim 2", source_quote="Q2", tda_id="tda_2222222222222222", source_id="chunk_1"
        ),
        ExtractedAtom(
            reasoning="R3", resolved_claim="Claim 3", source_quote="Q3", tda_id="tda_3333333333333333", source_id="chunk_2"
        ),
    ]
