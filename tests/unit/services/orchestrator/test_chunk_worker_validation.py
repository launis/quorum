...
from backend_v2.models.v2_core import PromptBlock, MatrixScale, MatrixClaim, TDAAssertion, I18nText
...
async def test_chunk_worker_pop_reasoning_steps_bug():
    ...
    block = PromptBlock(id=sr_id, slug="test", category_id="matrix", scales=[scale], label=i18n_label, description=i18n_label, type="string")
