...
<system_prompt>
  ...
  <execution_protocol level="2">
    ...
    <step id="3">CONSTRAINTS: For every single step, perform manual or automated verification to ensure that the code behaves exactly as expected before moving to the next milestone.</step>
