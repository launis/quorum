...
<system_prompt>
  ...
  <context_rules>
    ...
    <rule_block id="anti_ambiguity_mandate">
      ...
      <catastrophic_reason>Ambiguity and "Hidden Scope" in plans lead to implementation agents guessing wrong paths, missing test fixtures, or mapping incorrect SDUI blocks. Ambiguous terms introduce incomplete lists, causing agents to hallucinate scope and trigger immediate Fail-Fast crashes.</catastrophic_reason>
    </rule_block>
  </context_rules>
