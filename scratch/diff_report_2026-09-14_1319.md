...
- **Git / Epic -tila:** Branch: main | Commit: d61b8147 - fix(scripts): resolve diff script import path and auto-reconstitute trace (Mon Sep 14 12:50:40 2026 +0300)
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **exe_26f38060c9bd4ef3** | Kyllä | 6 | 5 | 1 | 83.3 % |
| **exe_1aaabc9556704edc** | Kyllä | 8 | 5 | 3 | 62.5 % |
...
| `tda_5198e13cde3447fe9d0737a80abe458c` | `Luovuus ja syvyys (Bloomin Taksonomia)` | Arviointi | FAILED | PASSED | 0% | Kyllä | Ei |
