...
- **Git / Epic -tila:** Branch: main | Commit: d6bd1e5a - feat(scoring): relocate scoring penalties to workflow and enforce dumb painter in blueprint (Tue Sep 15 10:32:47 2026 +0300)
- **Kriittiset järjestelmäarvot (Enums):**
Virhe Enumien luvussa: module 'backend_v2.models.enums' has no attribute 'ScoringStrategy'
- **Vertailtavat ajot (R1, R2...):**
  - **R1:** `exe_2b7f3a9e32b64c06`
  - **R2:** `exe_ebb9be993318400b`
...
- **Työnkulun Provenienssi ja Hallintokytkimet (Workflow Provenance & Invariants):**
  ...
  - **Prompt-direktiivien tiiviste (SHA-256):** `4d96b4c2006d80ff...` (743,004 merkkiä)
...
- **Run 1:** `exe_2b7f3a9e32b64c06` (Lähde: [data\files\executions\exe_2b7f3a9e32b64c06\execution_trace.json](file:///C:/src/quorum/data/files/executions/exe_2b7f3a9e32b64c06/execution_trace.json))
  - **Malli(t):** `fast (898,815 tok), reasoning (405,425 tok), synthesis (46,506 tok)` (Chunk size: None, Max Evals: None, Sampling: 0 (Kaikki 85 atomia, Tuotanto))
  - **Ajotila ja Rinnakkaisuus:** Tila: `production`, Max retries: `2`, Chunk size: `-`, Max Evals: `-`, Sampling: `0 (Kaikki 85 atomia, Tuotanto)`
  - **Kesto:** `6.0 minuuttia (357.1 s)`
  - **API-kutsut:** `6` kpl (Välimuistiosumat: `4/6` (66.7 %))
  - **Tokenit:** `1,649,809` (Syöte: `1,170,710`, Tuotos: `180,036`, Ajattelu: `133,886`, Välimuisti: `510,554`, Synteesi: `165,177`)
  - **Kustannusarvio:** `$1.3602` (DAG: `$1.2085`, Synteesi: `$0.1516`)
  - **Hitain askel (Pullonkaula):** `sr_03c1d71000000003` (123.9 s)
  - **Tekniset virheet (Crash):** `0` kpl
  - **DLQ-pudotetut atomit:** `0` kpl
  - **Kelvollisuus:** [KELVOLLINEN]
  - **Käytetyt syötetiedostot:**
    - [input_assignment_context.md](file:///C:/src/quorum/data/files/executions/exe_2b7f3a9e32b64c06/inputs/input_assignment_context.md) (SHA-256: `946641d434e0aabf...`, Variaatio: `No-Break Space (U+00A0)`)
    - [input_chat_log.md](file:///C:/src/quorum/data/files/executions/exe_2b7f3a9e32b64c06/inputs/input_chat_log.md) (SHA-256: `025fcbf541095f8a...`, Variaatio: `No-Break Space (U+00A0)`)
    - [input_chat_log_ai_only.md](file:///C:/src/quorum/data/files/executions/exe_2b7f3a9e32b64c06/inputs/input_chat_log_ai_only.md) (SHA-256: `93c6a88e70f188d2...`, Variaatio: `No-Break Space (U+00A0)`)
    - [input_chat_log_user_only.md](file:///C:/src/quorum/data/files/executions/exe_2b7f3a9e32b64c06/inputs/input_chat_log_user_only.md) (SHA-256: `22a644923e7d9532...`, Variaatio: `No-Break Space (U+00A0)`)
    - [input_product_text.md](file:///C:/src/quorum/data/files/executions/exe_2b7f3a9e32b64c06/inputs/input_product_text.md) (SHA-256: `41c484dd97d537a2...`, Variaatio: `No-Break Space (U+00A0)`)
    - [input_reflection_text.md](file:///C:/src/quorum/data/files/executions/exe_2b7f3a9e32b64c06/inputs/input_reflection_text.md) (SHA-256: `ea0dcff828f98b52...`, Variaatio: `No-Break Space (U+00A0)`)
- **Run 2:** `exe_ebb9be993318400b` (Lähde: [data\files\executions\exe_ebb9be993318400b\execution_trace.json](file:///C:/src/quorum/data/files/executions/exe_ebb9be993318400b/execution_trace.json))
  - **Malli(t):** `fast (1,170,735 tok), reasoning (339,999 tok), synthesis (56,897 tok)` (Chunk size: None, Max Evals: None, Sampling: 0 (Kaikki 85 atomia, Tuotanto))
  - **Ajotila ja Rinnakkaisuus:** Tila: `production`, Max retries: `2`, Chunk size: `-`, Max Evals: `-`, Sampling: `0 (Kaikki 85 atomia, Tuotanto)`
  - **Kesto:** `11.5 minuuttia (691.0 s)`
  - **API-kutsut:** `6` kpl (Välimuistiosumat: `4/6` (66.7 %))
  - **Tokenit:** `1,854,099` (Syöte: `1,466,603`, Tuotos: `101,028`, Välimuisti: `901,376`, Synteesi: `286,468`)
  - **Kustannusarvio:** `$2.2201` (DAG: `$1.8295`, Synteesi: `$0.3906`)
  - **Hitain askel (Pullonkaula):** `sr_03c1d71000000004` (200.6 s)
  - **Tekniset virheet (Crash):** `0` kpl
  - **DLQ-pudotetut atomit:** `0` kpl
  - **Kelvollisuus:** [KELVOLLINEN]
  - **Käytetyt syötetiedostot:**
    - [input_assignment_context.md](file:///C:/src/quorum/data/files/executions/exe_ebb9be993318400b/inputs/input_assignment_context.md) (SHA-256: `18b5c2c559051109...`, Variaatio: `En Space (U+2002)`)
    - [input_chat_log.md](file:///C:/src/quorum/data/files/executions/exe_ebb9be993318400b/inputs/input_chat_log.md) (SHA-256: `c55857579b879eda...`, Variaatio: `No-Break Space (U+00A0), En Space (U+2002)`)
    - [input_chat_log_ai_only.md](file:///C:/src/quorum/data/files/executions/exe_ebb9be993318400b/inputs/input_chat_log_ai_only.md) (SHA-256: `1fc65c285a708a3e...`, Variaatio: `En Space (U+2002)`)
    - [input_chat_log_user_only.md](file:///C:/src/quorum/data/files/executions/exe_ebb9be993318400b/inputs/input_chat_log_user_only.md) (SHA-256: `014fb904a981a893...`, Variaatio: `No-Break Space (U+00A0), En Space (U+2002)`)
    - [input_product_text.md](file:///C:/src/quorum/data/files/executions/exe_ebb9be993318400b/inputs/input_product_text.md) (SHA-256: `733c893514dca15e...`, Variaatio: `En Space (U+2002)`)
    - [input_reflection_text.md](file:///C:/src/quorum/data/files/executions/exe_ebb9be993318400b/inputs/input_reflection_text.md) (SHA-256: `cd91b605a16e8ad6...`, Variaatio: `En Space (U+2002)`)
...
| :--- | :--- | :--- | :---: | :---: | :---: | :---: | :---: | :--- |
| **R1 (exe_2b7f3a9e32b64c06)** | `input_assignment_context.md` | Ulkoinen konteksti (External Normative Context) | 114 | 9 | 1,016 | 15 | 7 | No-Break Space (U+00A0) |
| **R2 (exe_ebb9be993318400b)** | `input_assignment_context.md` | Ulkoinen konteksti (External Normative Context) | 114 | 9 | 1,016 | 15 | 7 | En Space (U+2002) |
| **R1 (exe_2b7f3a9e32b64c06)** | `input_chat_log.md` | Raakaloki (Combined Raw Dialogue) | 5,489 | 330 | 48,790 | 462 | 0 | No-Break Space (U+00A0) |
| **R2 (exe_ebb9be993318400b)** | `input_chat_log.md` | Raakaloki (Combined Raw Dialogue) | 5,865 | 330 | 49,166 | 462 | 0 | No-Break Space (U+00A0), En Space (U+2002) |
| **R1 (exe_2b7f3a9e32b64c06)** | `input_chat_log_ai_only.md` | Ulkoinen konteksti (External Normative Context) | 5,334 | 328 | 47,127 | 448 | 0 | No-Break Space (U+00A0) |
| **R2 (exe_ebb9be993318400b)** | `input_chat_log_ai_only.md` | Ulkoinen konteksti (External Normative Context) | 5,710 | 328 | 47,503 | 448 | 0 | En Space (U+2002) |
| **R1 (exe_2b7f3a9e32b64c06)** | `input_chat_log_user_only.md` | Käyttäjädokumentaatio (Candidate Deliverable) | 113 | 2 | 922 | 14 | 0 | No-Break Space (U+00A0) |
| **R2 (exe_ebb9be993318400b)** | `input_chat_log_user_only.md` | Käyttäjädokumentaatio (Candidate Deliverable) | 113 | 2 | 922 | 14 | 0 | No-Break Space (U+00A0), En Space (U+2002) |
| **R1 (exe_2b7f3a9e32b64c06)** | `input_product_text.md` | Käyttäjädokumentaatio (Candidate Deliverable) | 442 | 42 | 5,355 | 22 | 9 | No-Break Space (U+00A0) |
| **R2 (exe_ebb9be993318400b)** | `input_product_text.md` | Käyttäjädokumentaatio (Candidate Deliverable) | 442 | 42 | 5,355 | 22 | 9 | En Space (U+2002) |
| **R1 (exe_2b7f3a9e32b64c06)** | `input_reflection_text.md` | Käyttäjädokumentaatio (Candidate Deliverable) | 128 | 13 | 1,053 | 7 | 0 | No-Break Space (U+00A0) |
| **R2 (exe_ebb9be993318400b)** | `input_reflection_text.md` | Käyttäjädokumentaatio (Candidate Deliverable) | 128 | 13 | 1,053 | 7 | 0 | En Space (U+2002) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| :--- | :--- | :--- | :---: |
| **R1 (exe_2b7f3a9e32b64c06)** | `input_assignment_context.md` | `946641d434e0aabfb108952d273a9ca6c2837946e87d30290e08e9b94c305af8` | `ERISTETTY` |
| **R2 (exe_ebb9be993318400b)** | `input_assignment_context.md` | `18b5c2c5590511097cb12dcee73869c8d19d07267b402f01afc7ee87cdf8e1b6` | `ERISTETTY` |
| **R1 (exe_2b7f3a9e32b64c06)** | `input_chat_log.md` | `025fcbf541095f8ae1256e61c0deab8d636d588b4aff6abf1c92d3146bc88012` | `ERISTETTY` |
| **R2 (exe_ebb9be993318400b)** | `input_chat_log.md` | `c55857579b879eda3d9a2253c4a7ba636e89007bcaca476d4748595c34ac8713` | `ERISTETTY` |
| **R1 (exe_2b7f3a9e32b64c06)** | `input_chat_log_ai_only.md` | `93c6a88e70f188d2452cf337792b912c514fb35147bcd51990a5566a47b34997` | `ERISTETTY` |
| **R2 (exe_ebb9be993318400b)** | `input_chat_log_ai_only.md` | `1fc65c285a708a3ed4b12e57009b30a40a1e7c2a0710597bc5e36e0084511cfc` | `ERISTETTY` |
| **R1 (exe_2b7f3a9e32b64c06)** | `input_chat_log_user_only.md` | `22a644923e7d9532594abfeabf50995c2139a6289144dd038a4530052eeae7ef` | `ERISTETTY` |
| **R2 (exe_ebb9be993318400b)** | `input_chat_log_user_only.md` | `014fb904a981a89366acaa41f4b8fecc1e9427703bd791f1f47a5518874e3641` | `ERISTETTY` |
| **R1 (exe_2b7f3a9e32b64c06)** | `input_product_text.md` | `41c484dd97d537a241102352418ceb523ec57d38060184fadc57c6ee2fe821ec` | `ERISTETTY` |
| **R2 (exe_ebb9be993318400b)** | `input_product_text.md` | `733c893514dca15eb32014f269a741e31ae9c95a7717954236bcbddd5b143af8` | `ERISTETTY` |
| **R1 (exe_2b7f3a9e32b64c06)** | `input_reflection_text.md` | `ea0dcff828f98b5252cb9656b45bdd18b514334f34b012cb93d74290d71db3cc` | `ERISTETTY` |
| **R2 (exe_ebb9be993318400b)** | `input_reflection_text.md` | `cd91b605a16e8ad6957e100ea9650093d5ed5152a73f092182ef7f3ca1f5c483` | `ERISTETTY` |
...
| :--- | :---: | :---: | :---: | :---: |
| **exe_2b7f3a9e32b64c06** | 510,554 | 4/6 (66.7 %) | Osittainen välimuistihyödyntäminen | `VÄLIMUISTIOSUMA (510,554 tok)` |
| **exe_ebb9be993318400b** | 901,376 | 4/6 (66.7 %) | Osittainen välimuistihyödyntäminen | `VÄLIMUISTIOSUMA (901,376 tok)` |

#### 3. Hajautettu Variaatiosyvyys ja Unicode-avaruus
| Ajo | Tiedosto | Havaittu Unicode-avaruus | Sanat | Semanttinen Invarianssi |
| :--- | :--- | :--- | :---: | :---: |
| **R1 (exe_2b7f3a9e32b64c06)** | `input_assignment_context.md` | No-Break Space (U+00A0) | 114 | `TÄYSI (100%)` |
| **R2 (exe_ebb9be993318400b)** | `input_assignment_context.md` | En Space (U+2002) | 114 | `TÄYSI (100%)` |
| **R1 (exe_2b7f3a9e32b64c06)** | `input_chat_log.md` | No-Break Space (U+00A0) | 5,489 | `TÄYSI (100%)` |
| **R2 (exe_ebb9be993318400b)** | `input_chat_log.md` | No-Break Space (U+00A0), En Space (U+2002) | 5,865 | `POIKKEAMA` |
| **R1 (exe_2b7f3a9e32b64c06)** | `input_chat_log_ai_only.md` | No-Break Space (U+00A0) | 5,334 | `TÄYSI (100%)` |
| **R2 (exe_ebb9be993318400b)** | `input_chat_log_ai_only.md` | En Space (U+2002) | 5,710 | `POIKKEAMA` |
| **R1 (exe_2b7f3a9e32b64c06)** | `input_chat_log_user_only.md` | No-Break Space (U+00A0) | 113 | `TÄYSI (100%)` |
| **R2 (exe_ebb9be993318400b)** | `input_chat_log_user_only.md` | No-Break Space (U+00A0), En Space (U+2002) | 113 | `TÄYSI (100%)` |
| **R1 (exe_2b7f3a9e32b64c06)** | `input_product_text.md` | No-Break Space (U+00A0) | 442 | `TÄYSI (100%)` |
| **R2 (exe_ebb9be993318400b)** | `input_product_text.md` | En Space (U+2002) | 442 | `TÄYSI (100%)` |
| **R1 (exe_2b7f3a9e32b64c06)** | `input_reflection_text.md` | No-Break Space (U+00A0) | 128 | `TÄYSI (100%)` |
| **R2 (exe_ebb9be993318400b)** | `input_reflection_text.md` | En Space (U+2002) | 128 | `TÄYSI (100%)` |
...
- **Fleissin Kappa ($\kappa_{Fleiss}$):** 0.8514
...
- **Cohenin Kappa ($\kappa_{Cohen}$):** 0.8515
- **Kappan Tieteellinen Tasoluokitus:** Lähes täydellinen sopivuus (Almost Perfect Agreement)
- **Keskivirhe (SE) ja 95 % Luottamusväli:** SE = `0.0585`, 95% CI = `[0.7369, 0.9661]`
...
| **41–60%: Keskitaso (Mid Standard)** | 20 | 2 | 90.0 % |
...
| :--- | :---: | :---: |
| **Tiedonhaun aukko (Retrieval Gap)** | 5 | 83.3 % |
| **Päättelyn aukko (Reasoning Gap)** | 0 | 0.0 % |
| **Kontekstuaalinen ohitus (Contextual Override)** | 1 | 16.7 % |
...
- **Keskimääräinen itseisarvopoikkeama (MAD - Mean Absolute Delta):** `3.85` pistettä
- **Suurin yksittäisen lohkon poikkeama (Max Drift):** `11.85` pistettä
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **`blk_f921c7c0989b47e8` (Luovuus ja syvyys (Bloomin Taksonomia), Asteikko 1–6)** | Raw: 3.7 / 6 | Norm: 54.9 % | Raw: 4.3 / 6 | Norm: 66.8 % | +11.9 % | Taso 1.0 (3/5 osumaa) | Taso 1.0 (2/5 osumaa) | 63.3 % | 70.0 % | +6.7 % |
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **R1 (exe_2b7f3a9e32b64c06)** | 6 | 45 | 0 | 0 | 34 | 85 |
| **R2 (exe_ebb9be993318400b)** | 9 | 44 | 0 | 0 | 32 | 85 |

## FinOps & Välimuistisäästöt (Cache Economics & Cost Drift)

| FinOps -metriikka | Run 1 | Run 2 | $\Delta$ (R2 - R1) |
| :--- | :---: | :---: | :---: |
| **Kokonaiskustannus ($)** | $1.3602 | $2.2201 | $+0.8600 |
| **Syötetokenit (Prompt)** | 1,170,710 | 1,466,603 | +295,893 |
| **Tuotostokenit (Completion)** | 180,036 | 101,028 | -79,008 |
| **Välimuistitokenit (Cached)** | 510,554 | 901,376 | +390,822 |
| **Välimuistin tuoma säästö ($)** | $0.0287 | $0.0507 | +0.0220 |
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **exe_2b7f3a9e32b64c06** | Kyllä | 6 | 6 | 0 | 100.0 % |
| **exe_ebb9be993318400b** | Kyllä | 9 | 7 | 2 | 77.8 % |

## Kahden viimeisimmän ajon siirtymätilat (Run 1 -> Run 2)
- **Erimielisyyttä näiden välillä:** 6 kpl
- **Contextual Override -lähtöiset erimielisyydet koko setissä:** 1 / 6
- **PASSED -> FAILED:** 2
- **FAILED -> PASSED:** 4
- **Muut siirtymät:** 0
...
- **Run 1 (exe_2b7f3a9e32b64c06) - [FAILED]:**
  - **Sitaatti (Ei sitaattia):** -
  - **Perustelu:** *Strategiset arviot esitetään yleisinä ennusteina ja väitteinä ilman dokumentoitua empiiristä näyttöä tai vertailukriteereitä.*
- **Run 2 (exe_ebb9be993318400b) - [PASSED]:**
  - **Sitaatti (Löytyi, 249 merkkiä):** `**Johtopäätös:** Muutos 2017:n potentiaalista 2023:n kriisiin on peruuttamaton. Yrityksemme
...
päätöksentekoon ja nähdä **kestävyys ja autonomia** uusina kilpailutekijöinä.`
  - **Perustelu:** *Teksti esittää selkeän johtopäätöksen muutoksen luonteesta ja sen vaikutuksesta yrityksen menestykseen, perustellen sen aiemmalla analyysillä supermegatrendeistä.*
...
- **Run 1 (exe_2b7f3a9e32b64c06) - [FAILED]:**
  - **Sitaatti (Ei sitaattia):** -
  - **Perustelu:** *Tekstissä listataan suositeltuja toimenpiteitä, mutta abstraktia sääntökehystä ei kytketä suoraan ohjaamaan tiettyä operatiivista työnkulkua.*
- **Run 2 (exe_ebb9be993318400b) - [PASSED]:**
  - **Sitaatti (Löytyi, 315 merkkiä):** `Sitran näkemys suunnasta eteenpäin kiteytyy **tulevaisuusresilienssin** rakentamiseen –
kykyyn selviytyä jatkuvista kriiseistä ja samalla uudistua. Johtoryhmälle tämä tarkoittaa:

1.​ **Ekologian Integroiminen Talouteen:** ...
2.​ **Valinnan Paikkoihin Tarttuminen:** ...
3.​ **Ylisukupolvisuuden Edistäminen:** ...`
  - **Perustelu:** *Abstrakti käsite "tulevaisuusresilienssi" ja supermegatrendit sovelletaan suoraan johtoryhmän konkreettisiin strategisiin toimenpiteisiin ja liiketoimintamalleihin.*
...
- **Skooppi (Scope):** `paragraph` | **Käänteinen evidenssi (Inverse):** `Ei (False)`
- **Kysymys / Konsepti:** Surfacing unstated assumptions, implicit dependencies, or latent systemic incentives beneath surface arguments.
- **Etsintäsääntö (Extraction Rule):** The analysis uncovers unstated premises, structural couplings, or latent assumptions that govern system behavior.
- **Ankkuritargetti (Anchor Target):** Find articulation of unstated assumptions and latent dependencies.
- **Esimerkki (Contrastive Example):**
  - *Acceptable:* The microservice deployment relies on an unstated assumption of zero network partitioning and instantaneous clock synchronization.
  - *Rejected:* The deployment runs across three redundant server clusters in distinct availability zones.

**Havaitut tilat, sitaatit ja perustelut ajoittain:**
- **Run 1 (exe_2b7f3a9e32b64c06) - [FAILED]:**
  - **Sitaatti (Ei sitaattia):** -
  - **Perustelu:** *Analyysi ei paljasta piileviä rakenteellisia oletuksia tai insenttiivejä, vaan tarkastelee Sitran julkilausuttuja teemoja.*
- **Run 2 (exe_ebb9be993318400b) - [PASSED]:**
  - **Sitaatti (Löytyi, 96 merkkiä):** `Luonnon kantokyvyn rajat eivät ole vain _rajoite_,
vaan **uuden taloudellisen kasvun perusta** .`
  - **Perustelu:** *Teksti tuo esiin implisiittisen oletuksen, että ekologiset rajat ovat aiemmin nähty rajoitteena ja paljastaa, että talouden vakaus riippuu niiden integroinnista.*
...
**Havaitut tilat, sitaatit ja perustelut ajoittain:**
- **Run 1 (exe_2b7f3a9e32b64c06) - [PASSED]:**
  - **Sitaatti (Löytyi, 84 merkkiä):** `Sitran näkemyksen mukaan tulevaisuus ei vain vyöry päälle, vaan sen suunta on avoin.`
  - **Perustelu:** *Käyttäjä yhdistää käsitteet narratiivisen metaforan ("vyöry päälle") ja laadullisen rinnastuksen kautta ilman matemaattista johtamista.*
- **Run 2 (exe_ebb9be993318400b) - [FAILED]:**
  - **Sitaatti (Ei sitaattia):** -
  - **Perustelu:** *Käyttäjä ei itse kuvaa vertauskuvallisia yhteyksiä; metaforat ja semanttiset linkitykset (supermegatrendit) ovat AI:n generoimaa tekstiä.*
...
**Havaitut tilat, sitaatit ja perustelut ajoittain:**
- **Run 1 (exe_2b7f3a9e32b64c06) - [PASSED] **[CONTEXTUAL OVERRIDE]**:**
  - **Sitaatti (Ei sitaattia):** -
  - **Perustelu:** *Väitteet ja tulevaisuuskuvat sidotaan Sitran raportteihin ja sääntelykehyksiin, eikä ehdottomia yleistyksiä esitetä ilman perusteluja.*
- **Run 2 (exe_ebb9be993318400b) - [FAILED]:**
  - **Sitaatti (Ei sitaattia):** -
  - **Perustelu:** *Teksti tekee useita kategorisia väitteitä (esim. ettei paluuta vanhaan normaaliin ole, muutos on peruuttamaton) ilman viittauksia tai rajaavia ehtoja.*
...
- **Run 1 (exe_2b7f3a9e32b64c06) - [FAILED]:**
  - **Sitaatti (Ei sitaattia):** -
  - **Perustelu:** *Teksti ei sisällä eksplisiittistä reflektiivistä pysähdystä tai perusoletusten analyyttistä kyseenalaistamista, vaan ainoastaan ohjaavia kehotteita.*
- **Run 2 (exe_ebb9be993318400b) - [PASSED]:**
  ...
  - **Perustelu:** *Reflektio-osa osoittaa, että käyttäjä pysähtyy arvioimaan prosessia, virheitä ja muutoksia – tämä on eksplisiittinen kognitiivinen tauko.*
...
| `tda_5198e13cde3447fe9d0737a80abe458c` | `Luovuus ja syvyys (Bloomin Taksonomia)` | Arviointi | PASSED | PASSED | 100% | Kyllä | Kyllä |
...
| `tda_6a779cd5e9714994b83168dd0fef0ef7` | `Luovuus ja syvyys (Bloomin Taksonomia)` | Soveltaminen | FAILED | PASSED | 0% | Kyllä | Ei |
...
| `tda_bfbe65b639b54106913902d5bd0ae6ab` | `Luovuus ja syvyys (Bloomin Taksonomia)` | Analysointi | FAILED | PASSED | 0% | Kyllä | Kyllä |
