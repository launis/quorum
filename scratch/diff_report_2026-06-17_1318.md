...
- **Aktiiviset Säännöt ja Asetukset (Frozen Context):**Virhe frozen_context.json lukemisessa: 'charmap' codec can't encode character '\u2192' in position 1293: character maps to <undefined>
