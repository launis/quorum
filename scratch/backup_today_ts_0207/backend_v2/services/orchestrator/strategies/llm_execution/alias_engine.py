...
class AliasEngine:
    ...
    def alias_source_documents(self, source_docs: list[Any], global_source_text: str) -> str:
        ...
        Args:
            ...
            global_source_text: The compiled Markdown prompt text containing `### MATRIX INPUT:` blocks.

        Returns:
            The mutated Markdown string with obfuscated source_ids.
        """
        ...
        for i, doc in enumerate(source_docs):
            ...
            # String replacement for Markdown heading injection
            if mutated_text:
                mutated_text = mutated_text.replace(f"### MATRIX INPUT: {real_id}", f"### MATRIX INPUT: {alias}")
