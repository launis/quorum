...
async def test_blueprint_transformer_slop_scan_uses_system_repo() -> None:
    ...
    from backend_v2.models.domain.studio import ProfileModel
    ...
    # We must patch get_all_output_profiles_models to return our valid Pydantic model
