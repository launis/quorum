...
class PdfReportGenerator {
  ...
  pw.Widget _buildDriverProfile(Map<String, dynamic> data) {
    ...
    final strategies =
        (data['identified_strategies'] ?? data['tunnistetut_strategiat'])
            as List<dynamic>? ??
        [];
  ...
  pw.Widget _buildLogicAnalysis(Map<String, dynamic> data) {
    final toulmin =
        (data['toulmin_analysis'] ?? data['toulmin_analyysi'])
            as List<dynamic>? ??
        [];
  ...
  pw.Widget _buildArchivistCheck(Map<String, dynamic> data) {
    ...
    return pw.Column(
      ...
      children: [
        ...
        pw.Text(
          analysis != null && analysis.isNotEmpty ? analysis : "Ei analyysiä.",
        ),
      ],
    );
  }
  ...
  pw.Widget _buildFooter() {
    return pw.Center(
      child: pw.Text(
        "Cognitive Quorum Audit Report - Generated Automatically",
