...
/// The final output of the workflow (e.g., the Report object).
/// Only available in completed state.
@JsonKey(name: 'results') Map<String, dynamic> get result {
