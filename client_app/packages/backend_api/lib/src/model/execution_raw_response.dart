...
class ExecutionRawResponse {
  ...
  @JsonKey(name: r'workflow_id', required: true, includeIfNull: true)
  ...
  @JsonKey(name: r'duration_seconds', required: false)
  final num? durationSeconds;

  @JsonKey(defaultValue: {}, name: r'inputs', required: false)
  final Map<String, Object>? inputs;

  @JsonKey(defaultValue: {}, name: r'results', required: false)
  final Map<String, Object>? results;

  @JsonKey(defaultValue: {}, name: r'state', required: false)
  final Map<String, Object>? state;

  @JsonKey(name: r'user_id', required: true, includeIfNull: true)
  final String? userId;

  @JsonKey(defaultValue: {}, name: r'agent_outputs', required: false)
  final Map<String, Object>? agentOutputs;

  @JsonKey(defaultValue: {}, name: r'hook_outputs', required: false)
  final Map<String, Object>? hookOutputs;

  @JsonKey(name: r'xai_report', required: false)
  final String? xaiReport;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is ExecutionRawResponse &&
          other.id == id &&
  ...
  factory ExecutionRawResponse.fromJson(Map<String, dynamic> json) =>
      _$ExecutionRawResponseFromJson(json);
