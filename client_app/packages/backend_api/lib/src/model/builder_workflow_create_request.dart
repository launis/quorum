...
class BuilderWorkflowCreateRequest {
  ...
  final List<Map<String, Object>>? scoringLogic;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is BuilderWorkflowCreateRequest &&
      other.name == name &&
  ...
  factory BuilderWorkflowCreateRequest.fromJson(Map<String, dynamic> json) => _$BuilderWorkflowCreateRequestFromJson(json);
