...
class OrganizationUsageResponse {
  ...
  final String period;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is OrganizationUsageResponse &&
  ...
  factory OrganizationUsageResponse.fromJson(Map<String, dynamic> json) => _$OrganizationUsageResponseFromJson(json);
