...
class KnowledgeStatusResponse {
  ...
  final int precedentCount;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is KnowledgeStatusResponse &&
    ...
    int get hashCode =>
        ...
        precedentCount.hashCode;

  factory KnowledgeStatusResponse.fromJson(Map<String, dynamic> json) => _$KnowledgeStatusResponseFromJson(json);
