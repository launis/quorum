...
class GeneratedPhrasesResponse {
  ...
  @JsonKey(name: r'added_phrases', required: true)
  final List<String> addedPhrases;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is GeneratedPhrasesResponse &&
          other.status == status &&
  ...
  @override
  int get hashCode =>
      status.hashCode + message.hashCode + addedPhrases.hashCode;

  factory GeneratedPhrasesResponse.fromJson(Map<String, dynamic> json) =>
      _$GeneratedPhrasesResponseFromJson(json);
