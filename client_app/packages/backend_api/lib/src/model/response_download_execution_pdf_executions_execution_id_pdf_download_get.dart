...
class ResponseDownloadExecutionPdfExecutionsExecutionIdPdfDownloadGet {
  ...
  final String message;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is ResponseDownloadExecutionPdfExecutionsExecutionIdPdfDownloadGet &&
      other.status == status &&
      other.exists == exists &&
  ...
  factory ResponseDownloadExecutionPdfExecutionsExecutionIdPdfDownloadGet.fromJson(Map<String, dynamic> json) => _$ResponseDownloadExecutionPdfExecutionsExecutionIdPdfDownloadGetFromJson(json);

  Map<String, dynamic> toJson() => _$ResponseDownloadExecutionPdfExecutionsExecutionIdPdfDownloadGetToJson(this);
