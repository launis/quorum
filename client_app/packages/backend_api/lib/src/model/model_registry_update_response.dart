...
class ModelRegistryUpdateResponse {
  ...
  final Map<String, Map<String, String>> registry;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is ModelRegistryUpdateResponse &&
      other.status == status &&
  ...
  factory ModelRegistryUpdateResponse.fromJson(Map<String, dynamic> json) => _$ModelRegistryUpdateResponseFromJson(json);
