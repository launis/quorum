...
class AdHocTestRequest {
  ...
  final Map<String, Object>? modelParams;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is AdHocTestRequest &&
  ...
  factory AdHocTestRequest.fromJson(Map<String, dynamic> json) => _$AdHocTestRequestFromJson(json);
