...
class BodyRunAgentAgentsAgentNameRunPost {
  ...
  final String? model;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is BodyRunAgentAgentsAgentNameRunPost &&
      other.inputs == inputs &&
  ...
  factory BodyRunAgentAgentsAgentNameRunPost.fromJson(Map<String, dynamic> json) => _$BodyRunAgentAgentsAgentNameRunPostFromJson(json);

  Map<String, dynamic> toJson() => _$BodyRunAgentAgentsAgentNameRunPostToJson(this);
