...
class SystemSettings {
  ...
  @JsonKey(defaultValue: false, name: r'maintenance_mode', required: false)
  final bool? maintenanceMode;

  /// If True, new users can register.
  @JsonKey(defaultValue: true, name: r'allow_signups', required: false)
  final bool? allowSignups;

  @JsonKey(name: r'global_banner', required: false)
  ...
  @JsonKey(defaultValue: false, name: r'enable_beta_features', required: false)
