...
class KnowledgeJobStatusResponse {
  ...
  final String? errorCode;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is KnowledgeJobStatusResponse &&
      other.jobId == jobId &&
      other.status == status &&
  ...
  factory KnowledgeJobStatusResponse.fromJson(Map<String, dynamic> json) => _$KnowledgeJobStatusResponseFromJson(json);
