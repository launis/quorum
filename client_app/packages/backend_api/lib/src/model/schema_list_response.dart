...
class SchemaListResponse {
  ...
  SchemaListResponse({required this.items});

  @JsonKey(name: r'items', required: true)
  final Map<String, SchemaInfo> items;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is SchemaListResponse && other.items == items;

  @override
  int get hashCode => items.hashCode;

  factory SchemaListResponse.fromJson(Map<String, dynamic> json) =>
      _$SchemaListResponseFromJson(json);
