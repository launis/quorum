...
class RegistryComponentItem {
  ...
  final String? citation;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is RegistryComponentItem &&
      other.id == id &&
      other.slug == slug &&
      other.name == name &&
      other.type == type &&
  ...
  factory RegistryComponentItem.fromJson(Map<String, dynamic> json) => _$RegistryComponentItemFromJson(json);
