...
class UserAdminView {
  ...
  @JsonKey(name: r'last_login_at', required: false)
  final DateTime? lastLoginAt;

  @JsonKey(defaultValue: 0, name: r'execution_count', required: false)
  final int? executionCount;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is UserAdminView &&
          other.email == email &&
