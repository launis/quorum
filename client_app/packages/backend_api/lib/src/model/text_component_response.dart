...
class TextComponentResponse {
  ...
  final String content;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is TextComponentResponse &&
      other.id == id &&
      other.slug == slug &&
      other.name == name &&
  ...
  factory TextComponentResponse.fromJson(Map<String, dynamic> json) => _$TextComponentResponseFromJson(json);
