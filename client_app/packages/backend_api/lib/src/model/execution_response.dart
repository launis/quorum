...
class ExecutionResponse {
  ...
  @JsonKey(name: r'started_at', required: true)
  final DateTime startedAt;

  @JsonKey(name: r'completed_at', required: false)
  ...
  @JsonKey(name: r'user_id', required: true)
  final String userId;

  @JsonKey(name: r'organization_id', required: false)
  final String? organizationId;

  @JsonKey(name: r'workflow_name', required: false)
  final String? workflowName;

  @JsonKey(name: r'start_time', required: false)
  final DateTime? startTime;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is ExecutionResponse &&
          other.id == id &&
  ...
  factory ExecutionResponse.fromJson(Map<String, dynamic> json) =>
      _$ExecutionResponseFromJson(json);
