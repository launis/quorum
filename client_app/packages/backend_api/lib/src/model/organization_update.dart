...
class OrganizationUpdate {
  ...
  @JsonKey(name: r'tier', required: false)
  final String? tier;
  ...
  @JsonKey(name: r'subscription_status', required: false)
  final SubscriptionStatus? subscriptionStatus;

  @JsonKey(name: r'quota_limit', required: false)
  final num? quotaLimit;

  @JsonKey(name: r'tpm_limit', required: false)
  final int? tpmLimit;

  @JsonKey(name: r'rpm_limit', required: false)
  final int? rpmLimit;
