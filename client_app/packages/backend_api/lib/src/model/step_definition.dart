...
class StepDefinition {
  ...
  /// Task Key (DB source)
  @JsonKey(defaultValue: 'analyst', name: r'task_key', required: false)
  final String? taskKey;

  /// Configuration (DB source)
  @JsonKey(defaultValue: {}, name: r'config', required: false)
  ...
  @JsonKey(defaultValue: false, name: r'is_missing_registry', required: false)
