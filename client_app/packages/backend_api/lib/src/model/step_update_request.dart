...
class StepUpdateRequest {
  ...
  StepUpdateRequest({this.name, this.config});
  ...
  factory StepUpdateRequest.fromJson(Map<String, dynamic> json) =>
      _$StepUpdateRequestFromJson(json);
