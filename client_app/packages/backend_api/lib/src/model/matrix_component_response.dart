...
class MatrixComponentResponse {
  ...
  final MatrixContentDTO content;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is MatrixComponentResponse &&
      other.id == id &&
      other.slug == slug &&
      other.name == name &&
  ...
  factory MatrixComponentResponse.fromJson(Map<String, dynamic> json) => _$MatrixComponentResponseFromJson(json);
