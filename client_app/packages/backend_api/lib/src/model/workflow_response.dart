...
class WorkflowResponse {
  ...
  @JsonKey(defaultValue: {}, name: r'default_model_mapping', required: false)
  final Map<String, String>? defaultModelMapping;

  @JsonKey(defaultValue: {}, name: r'ui_schema', required: false)
  ...
  @JsonKey(name: r'updated_at', required: false)
  final dynamic? updatedAt;

  @JsonKey(name: r'organization_id', required: true)
  final String organizationId;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is WorkflowResponse &&
          other.id == id &&
          other.name == name &&
