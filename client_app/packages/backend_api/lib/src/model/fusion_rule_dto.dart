...
class FusionRuleDTO {
  ...
  @JsonKey(name: r'replaces_components', required: true)
  final List<String> replacesComponents;

  @JsonKey(name: r'min_steps', required: true)
  final int minSteps;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is FusionRuleDTO &&
  ...
  factory FusionRuleDTO.fromJson(Map<String, dynamic> json) =>
      _$FusionRuleDTOFromJson(json);
