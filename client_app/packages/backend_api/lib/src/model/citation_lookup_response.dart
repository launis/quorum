...
class CitationLookupResponse {
  ...
  final Map<String, List<Map<String, Object>>> results;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is CitationLookupResponse &&
  ...
  factory CitationLookupResponse.fromJson(Map<String, dynamic> json) => _$CitationLookupResponseFromJson(json);
