...
_responseData = rawData == null ? null : deserialize<ExecutionResponse, ExecutionResponse>(rawData, 'ExecutionResponse', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ExecutionDeleteResponse>> deleteExecutionV1ExecuteExecutionIdDelete({ 
    ...
    final _path = r'/v1/execute/{execution_id}'.replaceAll('{' r'execution_id' '}', executionId.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        r'authorization': authorization,
...
_responseData = rawData == null ? null : deserialize<ExecutionDeleteResponse, ExecutionDeleteResponse>(rawData, 'ExecutionDeleteResponse', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Map<String, Object>>> executeWorkflowRouteV1ExecuteWorkflowIdPost({ 
    ...
    final _path = r'/v1/execute/{workflow_id}'.replaceAll('{' r'workflow_id' '}', workflowId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
