...
class ExecutionV1Api {
  final Dio _dio;

  const ExecutionV1Api(this._dio);
  ...
  Future<Response<ExecutionResponse>> createExecutionV1ExecutePost({
  ...
  deleteExecutionV1ExecuteExecutionIdDelete({
    ...
    final _path = r'/v1/execute/{execution_id}'.replaceAll(
      '{'
      r'execution_id'
      '}',
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Map<String, Object>>>
  executeWorkflowRouteV1ExecuteWorkflowIdPost({
    ...
    final _path = r'/v1/execute/{workflow_id}'.replaceAll(
      '{'
      r'workflow_id'
      '}',
      workflowId.toString(),
