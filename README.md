...
2.  **Start the Services (Local Mode):**
...
3.  **Execute a Workflow:**
    Use the Frontend UI to select and run a workflow, or send a POST request to the API.
...
[Read Documentation](https://github.com/launis/quorum/blob/main/docs/index.md)
