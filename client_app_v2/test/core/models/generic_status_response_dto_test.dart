...
void main() {
  group('GenericStatusResponseDto', () {
    ...
    test('Negative Test 1: throws exception on unrecognized keys due to disallowUnrecognizedKeys', () {
      final invalidJson = {
        'status': 'ok',
        'message': 'Saved successfully',
    ...
    test('Negative Test 2: throws exception when required message field is missing', () {
