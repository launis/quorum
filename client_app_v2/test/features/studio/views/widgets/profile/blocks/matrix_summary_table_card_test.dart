...
void main() {
  testWidgets('MatrixSummaryTableCard renders visible column chips and handles selection', (
    WidgetTester tester,
  ) async {
    ...
    final summaryBlock = payload.layouts.firstWhere((l) => l.presetView == PresetView.matrixSummary);
