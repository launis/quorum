...
import 'package:client_app_v2/features/studio/views/widgets/xai/matrix_observability_accordion.dart';

void main() {
  testWidgets('MatrixObservabilityAccordion renders atomic statistics correctly', (WidgetTester tester) async {
