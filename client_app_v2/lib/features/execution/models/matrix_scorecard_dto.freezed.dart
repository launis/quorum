...
@JsonKey(name: 'new_status') ExecutionStatus get newStatus; String get reason;@JsonKey(name: 'evidence_quotes') List<QuoteEvidenceDto> get evidenceQuotes;@JsonKey(name: 'overridden_by') String get overriddenBy;@JsonKey(name: 'overridden_at') DateTime get overriddenAt;
...
@useResult
$Res call({
@JsonKey(name: 'new_status') ExecutionStatus newStatus, String reason,@JsonKey(name: 'evidence_quotes') List<QuoteEvidenceDto> evidenceQuotes,@JsonKey(name: 'overridden_by') String overriddenBy,@JsonKey(name: 'overridden_at') DateTime overriddenAt
});
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'new_status')  ExecutionStatus newStatus,  String reason, @JsonKey(name: 'evidence_quotes')  List<QuoteEvidenceDto> evidenceQuotes, @JsonKey(name: 'overridden_by')  String overriddenBy, @JsonKey(name: 'overridden_at')  DateTime overriddenAt)  $default,) {final _that = this;
switch (_that) {
case _HumanOverrideDto():
return $default(_that.newStatus,_that.reason,_that.evidenceQuotes,_that.overriddenBy,_that.overriddenAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'new_status')  ExecutionStatus newStatus,  String reason, @JsonKey(name: 'evidence_quotes')  List<QuoteEvidenceDto> evidenceQuotes, @JsonKey(name: 'overridden_by')  String overriddenBy, @JsonKey(name: 'overridden_at')  DateTime overriddenAt)?  $default,) {final _that = this;
switch (_that) {
case _HumanOverrideDto() when $default != null:
return $default(_that.newStatus,_that.reason,_that.evidenceQuotes,_that.overriddenBy,_that.overriddenAt);case _:
  return null;
...
as ExecutionStatus?,semanticReasoning: null == semanticReasoning ? _self.semanticReasoning : semanticReasoning // ignore: cast_nullable_to_non_nullable
...
@JsonKey(name: 'block_id') String get blockId; String get name;@JsonKey(name: 'label_i18n') I18nText get labelI18n; String? get description; double? get score;@JsonKey(name: 'score_display_label') String? get scoreDisplayLabel;@JsonKey(name: 'scale_min') double? get scaleMin;@JsonKey(name: 'scale_max') double? get scaleMax;@JsonKey(name: 'normalized_score') double? get normalizedScore;@JsonKey(name: 'true_atoms') int? get trueAtoms;@JsonKey(name: 'total_atoms') int? get totalAtoms;@JsonKey(name: 'row_explanation') String get rowExplanation;@JsonKey(name: 'cited_source_id') String? get citedSourceId;@JsonKey(name: 'cited_text_quote') String? get citedTextQuote;@JsonKey(name: 'cited_web_citation') String? get citedWebCitation;@JsonKey(name: 'cited_source_title') String? get citedSourceTitle;@JsonKey(name: 'cited_source_url') String? get citedSourceUrl;@JsonKey(name: 'context_target') String? get contextTarget;@JsonKey(name: 'context_target_label') I18nText? get contextTargetLabel;@JsonKey(name: 'remediation_steps') String? get remediationSteps;@JsonKey(name: 'coaching') String? get coaching;@JsonKey(name: 'falsification') String? get falsification;@JsonKey(name: 'evidence_type') EvidenceType? get evidenceType;@JsonKey(name: 'tda_state') TDAState? get tdaState; double? get confidence;@JsonKey(name: 'inner_sdui_blocks') List<SduiBlockDTO> get innerSduiBlocks;@JsonKey(name: 'level_breakdown') Map<String, String>? get levelBreakdown;@JsonKey(name: 'level_names') Map<String, String>? get levelNames;@JsonKey(name: 'ui_boundary_labels') Map<String, String>? get uiBoundaryLabels;@JsonKey(name: 'ui_plot_ratio') double? get uiPlotRatio;@JsonKey(name: 'is_evaluative') bool get isEvaluative;@JsonKey(name: 'allow_contextual_override') bool get allowContextualOverride;@JsonKey(name: 'contextual_override') bool? get contextualOverride;@JsonKey(name: 'semantic_reasoning') String? get semanticReasoning;@JsonKey(name: 'evaluated_atoms') List<ScorecardAtomDto> get evaluatedAtoms;@JsonKey(name: 'clustered_row_sources') List<McpAuditTraceDto> get clusteredRowSources;@JsonKey(name: 'used_evidence_ids') List<String> get usedEvidenceIds;
...
@override
String toString() {
  return 'MatrixScorecardRowDto(blockId: $blockId, name: $name, labelI18n: $labelI18n, description: $description, score: $score, scoreDisplayLabel: $scoreDisplayLabel, scaleMin: $scaleMin, scaleMax: $scaleMax, normalizedScore: $normalizedScore, trueAtoms: $trueAtoms, totalAtoms: $totalAtoms, rowExplanation: $rowExplanation, citedSourceId: $citedSourceId, citedTextQuote: $citedTextQuote, citedWebCitation: $citedWebCitation, citedSourceTitle: $citedSourceTitle, citedSourceUrl: $citedSourceUrl, contextTarget: $contextTarget, contextTargetLabel: $contextTargetLabel, remediationSteps: $remediationSteps, coaching: $coaching, falsification: $falsification, evidenceType: $evidenceType, tdaState: $tdaState, confidence: $confidence, innerSduiBlocks: $innerSduiBlocks, levelBreakdown: $levelBreakdown, levelNames: $levelNames, uiBoundaryLabels: $uiBoundaryLabels, uiPlotRatio: $uiPlotRatio, isEvaluative: $isEvaluative, allowContextualOverride: $allowContextualOverride, contextualOverride: $contextualOverride, semanticReasoning: $semanticReasoning, evaluatedAtoms: $evaluatedAtoms, clusteredRowSources: $clusteredRowSources, usedEvidenceIds: $usedEvidenceIds)';
}
...
@useResult
$Res call({
@JsonKey(name: 'block_id') String blockId, String name,@JsonKey(name: 'label_i18n') I18nText labelI18n, String? description, double? score,@JsonKey(name: 'score_display_label') String? scoreDisplayLabel,@JsonKey(name: 'scale_min') double? scaleMin,@JsonKey(name: 'scale_max') double? scaleMax,@JsonKey(name: 'normalized_score') double? normalizedScore,@JsonKey(name: 'true_atoms') int? trueAtoms,@JsonKey(name: 'total_atoms') int? totalAtoms,@JsonKey(name: 'row_explanation') String rowExplanation,@JsonKey(name: 'cited_source_id') String? citedSourceId,@JsonKey(name: 'cited_text_quote') String? citedTextQuote,@JsonKey(name: 'cited_web_citation') String? citedWebCitation,@JsonKey(name: 'cited_source_title') String? citedSourceTitle,@JsonKey(name: 'cited_source_url') String? citedSourceUrl,@JsonKey(name: 'context_target') String? contextTarget,@JsonKey(name: 'context_target_label') I18nText? contextTargetLabel,@JsonKey(name: 'remediation_steps') String? remediationSteps,@JsonKey(name: 'coaching') String? coaching,@JsonKey(name: 'falsification') String? falsification,@JsonKey(name: 'evidence_type') EvidenceType? evidenceType,@JsonKey(name: 'tda_state') TDAState? tdaState, double? confidence,@JsonKey(name: 'inner_sdui_blocks') List<SduiBlockDTO> innerSduiBlocks,@JsonKey(name: 'level_breakdown') Map<String, String>? levelBreakdown,@JsonKey(name: 'level_names') Map<String, String>? levelNames,@JsonKey(name: 'ui_boundary_labels') Map<String, String>? uiBoundaryLabels,@JsonKey(name: 'ui_plot_ratio') double? uiPlotRatio,@JsonKey(name: 'is_evaluative') bool isEvaluative,@JsonKey(name: 'allow_contextual_override') bool allowContextualOverride,@JsonKey(name: 'contextual_override') bool? contextualOverride,@JsonKey(name: 'semantic_reasoning') String? semanticReasoning,@JsonKey(name: 'evaluated_atoms') List<ScorecardAtomDto> evaluatedAtoms,@JsonKey(name: 'clustered_row_sources') List<McpAuditTraceDto> clusteredRowSources,@JsonKey(name: 'used_evidence_ids') List<String> usedEvidenceIds
});


$I18nTextCopyWith<$Res> get labelI18n;$I18nTextCopyWith<$Res>? get contextTargetLabel;$TDAStateCopyWith<$Res>? get tdaState;
...
/// Create a copy of MatrixScorecardRowDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? blockId = null,Object? name = null,Object? labelI18n = null,Object? description = freezed,Object? score = freezed,Object? scoreDisplayLabel = freezed,Object? scaleMin = freezed,Object? scaleMax = freezed,Object? normalizedScore = freezed,Object? trueAtoms = freezed,Object? totalAtoms = freezed,Object? rowExplanation = null,Object? citedSourceId = freezed,Object? citedTextQuote = freezed,Object? citedWebCitation = freezed,Object? citedSourceTitle = freezed,Object? citedSourceUrl = freezed,Object? contextTarget = freezed,Object? contextTargetLabel = freezed,Object? remediationSteps = freezed,Object? coaching = freezed,Object? falsification = freezed,Object? evidenceType = freezed,Object? tdaState = freezed,Object? confidence = freezed,Object? innerSduiBlocks = null,Object? levelBreakdown = freezed,Object? levelNames = freezed,Object? uiBoundaryLabels = freezed,Object? uiPlotRatio = freezed,Object? isEvaluative = null,Object? allowContextualOverride = null,Object? contextualOverride = freezed,Object? semanticReasoning = freezed,Object? evaluatedAtoms = null,Object? clusteredRowSources = null,Object? usedEvidenceIds = null,}) {
  return _then(_self.copyWith(
...
as String?,citedSourceTitle: freezed == citedSourceTitle ? _self.citedSourceTitle : citedSourceTitle // ignore: cast_nullable_to_non_nullable
as String?,citedSourceUrl: freezed == citedSourceUrl ? _self.citedSourceUrl : citedSourceUrl // ignore: cast_nullable_to_non_nullable
as String?,contextTarget: freezed == contextTarget ? _self.contextTarget : contextTarget // ignore: cast_nullable_to_non_nullable
as String?,contextTargetLabel: freezed == contextTargetLabel ? _self.contextTargetLabel : contextTargetLabel // ignore: cast_nullable_to_non_nullable
as I18nText?,remediationSteps: freezed == remediationSteps ? _self.remediationSteps : remediationSteps // ignore: cast_nullable_to_non_nullable
as String?,coaching: freezed == coaching ? _self.coaching : coaching // ignore: cast_nullable_to_non_nullable
as String?,falsification: freezed == falsification ? _self.falsification : falsification // ignore: cast_nullable_to_non_nullable
...
as bool,allowContextualOverride: null == allowContextualOverride ? _self.allowContextualOverride : allowContextualOverride // ignore: cast_nullable_to_non_nullable
...
@override
@pragma('vm:prefer-inline')
$I18nTextCopyWith<$Res>? get contextTargetLabel {
    if (_self.contextTargetLabel == null) {
    return null;
  }

  return $I18nTextCopyWith<$Res>(_self.contextTargetLabel!, (value) {
    return _then(_self.copyWith(contextTargetLabel: value));
  });
}/// Create a copy of MatrixScorecardRowDto
/// with the given fields replaced by the non-null parameter values.
@override
...
switch (_that) {
case _MatrixScorecardRowDto() when $default != null:
return $default(_that.blockId,_that.name,_that.labelI18n,_that.description,_that.score,_that.scoreDisplayLabel,_that.scaleMin,_that.scaleMax,_that.normalizedScore,_that.trueAtoms,_that.totalAtoms,_that.rowExplanation,_that.citedSourceId,_that.citedTextQuote,_that.citedWebCitation,_that.citedSourceTitle,_that.citedSourceUrl,_that.contextTarget,_that.contextTargetLabel,_that.remediationSteps,_that.coaching,_that.falsification,_that.evidenceType,_that.tdaState,_that.confidence,_that.innerSduiBlocks,_that.levelBreakdown,_that.levelNames,_that.uiBoundaryLabels,_that.uiPlotRatio,_that.isEvaluative,_that.allowContextualOverride,_that.contextualOverride,_that.semanticReasoning,_that.evaluatedAtoms,_that.clusteredRowSources,_that.usedEvidenceIds);case _:
  return orElse();
...
@override@JsonKey(name: 'cited_source_title') final  String? citedSourceTitle;
@override@JsonKey(name: 'cited_source_url') final  String? citedSourceUrl;
@override@JsonKey(name: 'context_target') final  String? contextTarget;
@override@JsonKey(name: 'context_target_label') final  I18nText? contextTargetLabel;
@override@JsonKey(name: 'remediation_steps') final  String? remediationSteps;
@override@JsonKey(name: 'coaching') final  String? coaching;
@override@JsonKey(name: 'falsification') final  String? falsification;
...
@override $I18nTextCopyWith<$Res> get labelI18n;@override $I18nTextCopyWith<$Res>? get contextTargetLabel;@override $TDAStateCopyWith<$Res>? get tdaState;
