...
_MatrixScorecardRowDto _$MatrixScorecardRowDtoFromJson(
  ...
  ($checkedConvert) {
    ...
    final val = _MatrixScorecardRowDto(
      ...
      citedSourceTitle: $checkedConvert(
        'cited_source_title',
        (v) => v as String?,
      ),
      citedSourceUrl: $checkedConvert('cited_source_url', (v) => v as String?),
      contextTarget: $checkedConvert('context_target', (v) => v as String?),
      contextTargetLabel: $checkedConvert(
        'context_target_label',
  ...
  fieldKeyMap: const {
    ...
    'citedSourceTitle': 'cited_source_title',
    'citedSourceUrl': 'cited_source_url',
    'contextTarget': 'context_target',
    'contextTargetLabel': 'context_target_label',
...
Map<String, dynamic> _$MatrixScorecardRowDtoToJson(
  ...
  'cited_source_title': instance.citedSourceTitle,
  'cited_source_url': instance.citedSourceUrl,
  'context_target': instance.contextTarget,
  'context_target_label': instance.contextTargetLabel?.toJson(),
