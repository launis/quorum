...
switch (_that) {
case _ReportLayoutDto() when $default != null:
return $default(_that.presetView,_that.title,_that.description,_that.axes,_that.textDeliveryMode,_that.isSynthesisEnabled,_that.synthesis,_that.synthesisBlocks,_that.matrixVisibleColumns,_that.matrixColumnLabels,_that.extensionLabels);case _:
  return orElse();
...
class _ReportLayoutDto implements ReportLayoutDto {
  const _ReportLayoutDto({@JsonKey(name: 'preset_view', unknownEnumValue: PresetView.defaultView) this.presetView = PresetView.defaultView, this.title, this.description, final  List<MatrixScorecardRowDto> axes = const [], @JsonKey(name: 'text_delivery_mode', unknownEnumValue: TextDeliveryMode.full) this.textDeliveryMode = TextDeliveryMode.full, @JsonKey(name: 'is_synthesis_enabled') this.isSynthesisEnabled = true, this.synthesis, @JsonKey(name: 'synthesis_blocks') final  List<SduiBlockDTO>? synthesisBlocks, @JsonKey(name: 'matrix_visible_columns') final  List<String> matrixVisibleColumns = const [], @JsonKey(name: 'matrix_column_labels') final  Map<String, I18nText> matrixColumnLabels = const {}, @JsonKey(name: 'extension_labels') final  Map<String, I18nText> extensionLabels = const {}}): _axes = axes,_synthesisBlocks = synthesisBlocks,_matrixVisibleColumns = matrixVisibleColumns,_matrixColumnLabels = matrixColumnLabels,_extensionLabels = extensionLabels;
