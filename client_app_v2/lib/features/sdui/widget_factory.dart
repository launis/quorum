...
class SDUIWidgetFactory {
  ...
  static Widget buildWidget({
    ...
    switch (widgetType) {
      ...
      case 'textarea':
      case 'markdown':
        // Text/Markdown content generated by nodes (e.g., input_processing, mandates)
        // that shouldn't crash the widget factory, but aren't currently rendered as standalone SDUI cards.
        return const SizedBox.shrink();
