...
class PromptBlockBuilderView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PromptBlockBuilderView> createState() => _PromptBlockBuilderViewState();
}

class _PromptBlockBuilderViewState extends ConsumerState<PromptBlockBuilderView> {
        ...
        .then((_) {
          if (mounted) {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                content: Text('Prompt Block saved (Optimistic update applied).'),
              ),
            );
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      value: _editablePromptBlock['category_id'] as String? ?? 'system_rule',
                      items: const [
                        DropdownMenuItem(value: 'scientific_theory', child: Text('Scientific Theory')),
                        DropdownMenuItem(value: 'agent_role', child: Text('Agent Role')),
                        DropdownMenuItem(value: 'system_rule', child: Text('System Rule')),
                      ],
                      onChanged: (val) => setState(() => _editablePromptBlock['category_id'] = val),
                    ),
                    const SizedBox(height: 16),
                    ...
                    I18nTextField(
                      ...
                      initialData: SafeCast.safeMap(_editablePromptBlock['label']),
                    ...
                    I18nTextField(
                      ...
                      initialData: SafeCast.safeMap(_editablePromptBlock['description']),
                      onChanged: (val) => _editablePromptBlock['description'] = val,
                    ),
                    const SizedBox(height: 16),
                          ...
                          Wrap(
                            ...
                            children: [
                              DropdownButton<String>(
                                value: ['int', 'float', 'string', 'instruction', 'bool'].contains(_editablePromptBlock['type'])
                                        ? _editablePromptBlock['type'] as String
                                        : 'instruction',
                                items: const [
                                  DropdownMenuItem(value: 'instruction', child: Text('Text Instruction (No JSON Output)')),
                                ...
                                onChanged: (val) => setState(() => _editablePromptBlock['type'] = val),
                              ),
                              Row(
                                mainAxisSize: MainAxisSize.min,
                                children: [
                                  Checkbox(
                                    value: _editablePromptBlock['allow_decimals'] == true,
                                    onChanged: (val) => setState(() => _editablePromptBlock['allow_decimals'] = val),
                              ...
                              Row(
                                ...
                                children: [
                                  Checkbox(
                                    value: _editablePromptBlock['require_justification'] == true,
                                    onChanged: (val) => setState(() => _editablePromptBlock['require_justification'] = val),
                                  ),
                                  const Text('Require AI Justification (XAI)'),
                                ],
                              ),
                            ],
                          ),
                        ...
                        children: [
                           Row(
                             ...
                             children: [
                               ...
                               Switch(
                                 value: _editablePromptBlock['theory_grounding'] != null,
                                 onChanged: (val) {
                                   setState(() {
                                      if (val) {
                                        ...
                                        _editablePromptBlock['theory_grounding'] = null;
                                        _editablePromptBlock.remove('theory_grounding');
                                      }
                                   });
                                 }
                           ...
                           if (_editablePromptBlock['theory_grounding'] != null) ...[
                               ...
                               // Source URL
                                TextFormField(
                                  initialValue: SafeCast.safeMap(_editablePromptBlock['theory_grounding'])['source_url']?.toString(),
                                  decoration: const InputDecoration(
                                    labelText: 'Source URL (e.g. jstor.org/...)',
                                    border: UnderlineInputBorder(),
                                  ),
                                  onChanged: (val) {
                                    final grounding = SafeCast.safeMap(_editablePromptBlock['theory_grounding']);
                                    grounding['source_url'] = val;
                                  },
                                ),
                                const SizedBox(height: 8),
                                TextFormField(
                                  initialValue: SafeCast.safeMap(_editablePromptBlock['theory_grounding'])['citation_reference']?.toString(),
                                  decoration: const InputDecoration(
                                    labelText: 'Citation Reference (e.g. Kahnamen, 2011)',
                                    border: UnderlineInputBorder(),
                                  ),
                                  onChanged: (val) {
                                     final grounding = SafeCast.safeMap(_editablePromptBlock['theory_grounding']);
        ...
        child: Column(
          ...
          children: [
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                const Text('BARS Scales / Score Grades', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                Row(
                   children: [
                      Switch(
