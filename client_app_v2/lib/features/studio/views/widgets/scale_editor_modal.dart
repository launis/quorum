                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          AppSpacing.h8,
                          ...claim.tdaAssertions.asMap().entries.map((
                            tdaEntry,
                          ) {
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    DropdownButtonFormField<EvaluationTrack>(
                                      ...
                                      decoration: InputDecoration(
                                        labelText:
                                            l10n.scaleEvaluationTrackLabel,
                                        helperText:
                                            l10n.scaleEvaluationTrackHelper,
                                        border: const OutlineInputBorder(),
                                        contentPadding:
                                      ...
                                      items: EvaluationTrack.values.map((
                                        track,
                                      ) {
                                    ...
                                    TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        helperText:
                                            l10n.scaleConceptDescriptionHelper,
                                        border: const OutlineInputBorder(),
                                        contentPadding:
                                            const EdgeInsets.symmetric(
                                              horizontal: 10,
                                    ...
                                    DropdownButtonFormField<String>(
                                      ...
                                      items: [
                                        ...
                                        DropdownMenuItem(
                                          ...
                                          child: Text(
                                            l10n.tdaScopeAdjacentParagraphs,
                                          ),
                                        ),
                                        DropdownMenuItem(
                                          value: 'document',
                                    ...
                                    TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        helperText:
                                            l10n.scaleAcceptanceCriteriaHelper,
                                        border: const OutlineInputBorder(),
                                        contentPadding:
                                            const EdgeInsets.symmetric(
                                              horizontal: 10,
                                    ...
                                    DropdownButtonFormField<AggregationMode>(
                                      ...
                                      decoration: InputDecoration(
                                        labelText:
                                            l10n.scaleAggregationModeLabel,
                                        helperText:
                                            l10n.scaleAggregationModeHelper,
                                        border: const OutlineInputBorder(),
                                        contentPadding:
                                            const EdgeInsets.symmetric(
                                              horizontal: 10,
