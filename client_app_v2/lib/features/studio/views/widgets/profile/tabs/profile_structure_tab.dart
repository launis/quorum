...
/// Tab 4: Purified Report Structure view with reorderable toggles and inactive block tray.
class ProfileStructureTab extends ConsumerWidget {
  final String id;
  const ProfileStructureTab({super.key, required this.id});
      ...
      children: [
        ...
        ReorderableListView(
          ...
          children: activeBlocks.asMap().entries.map((entry) {
            ...
            return BlockCardRegistry.getSimpleToggleCard(
