...
@StrictOpaqueIdConverter() String get id; String get slug;@StrictOpaqueIdConverter() String get workflowId; String? get organizationId; I18nText get name; I18nText? get description;@JsonKey(name: 'user_role_label') I18nText? get userRoleLabel;@JsonKey(name: 'custom_preface') I18nText? get customPreface; List<String> get visibleMetadata;@JsonKey(name: 'matrix_visible_columns') List<String> get matrixVisibleColumns; List<XaiExtensionType> get visibleBlockExtensions; List<XaiExtensionType> get visibleWorkflowExtensions;@JsonKey(name: 'max_extension_items') int get maxExtensionItems;@JsonKey(name: 'display_scale') DisplayScale get displayScale;@JsonKey(name: 'custom_scale_min') double? get customScaleMin;@JsonKey(name: 'custom_scale_max') double? get customScaleMax;@JsonKey(name: 'strictness_level') int get strictnessLevel;@JsonKey(name: 'synthesis_length_constraint') int? get synthesisLengthConstraint;@JsonKey(name: 'row_explanation_length_constraint') int? get rowExplanationLengthConstraint;@JsonKey(name: 'xai_length_constraint') int? get xaiLengthConstraint;@JsonKey(name: 'variance_length_constraint') int? get varianceLengthConstraint;@JsonKey(name: 'matrix_graph_length_constraint') int? get matrixGraphLengthConstraint;@JsonKey(name: 'max_quotes_per_matrix') int? get maxQuotesPerMatrix;@JsonKey(name: 'max_unmet_criteria') int? get maxUnmetCriteria;@JsonKey(name: 'security_penalty') double get securityPenalty;@JsonKey(name: 'post_hoc_penalty') double get postHocPenalty;@JsonKey(name: 'passivity_penalty') double get passivityPenalty;@JsonKey(name: 'tone_instruction') String? get toneInstruction;@JsonKey(name: 'executive_summary_directive') String? get executiveSummaryDirective;@JsonKey(name: 'matrix_1d_synthesis_directive') String? get matrix1dSynthesisDirective;@JsonKey(name: 'matrix_2d_synthesis_directive') String? get matrix2dSynthesisDirective;@JsonKey(name: 'matrix_3d_synthesis_directive') String? get matrix3dSynthesisDirective;@JsonKey(name: 'matrix_text_synthesis_directive') String? get matrixTextSynthesisDirective;@JsonKey(name: 'row_explanation_directive') String? get rowExplanationDirective;@JsonKey(name: 'xai_synthesis_directive') String? get xaiSynthesisDirective;@JsonKey(name: 'variance_synthesis_directive') String? get varianceSynthesisDirective;@JsonKey(name: 'variance_target_block') String? get varianceTargetBlock;@JsonKey(name: 'user_role_target_block') String? get userRoleTargetBlock; SystemLocale? get language;@JsonKey(name: 'matrix_synthesis_groups') List<MatrixSynthesisGroup> get matrixSynthesisGroups;@JsonKey(name: 'content_blocks') List<SduiBlockDTO> get contentBlocks;@JsonKey(name: 'target_block_order') List<TargetBlockType> get targetBlockOrder;@JsonKey(name: 'show_sources_summary_box') bool get showSourcesSummaryBox;@JsonKey(name: 'sources_display_mode') SourcesDisplayMode get sourcesDisplayMode;
...
@override
String toString() {
  return 'OutputProfile(id: $id, slug: $slug, workflowId: $workflowId, organizationId: $organizationId, name: $name, description: $description, userRoleLabel: $userRoleLabel, customPreface: $customPreface, visibleMetadata: $visibleMetadata, matrixVisibleColumns: $matrixVisibleColumns, visibleBlockExtensions: $visibleBlockExtensions, visibleWorkflowExtensions: $visibleWorkflowExtensions, maxExtensionItems: $maxExtensionItems, displayScale: $displayScale, customScaleMin: $customScaleMin, customScaleMax: $customScaleMax, strictnessLevel: $strictnessLevel, synthesisLengthConstraint: $synthesisLengthConstraint, rowExplanationLengthConstraint: $rowExplanationLengthConstraint, xaiLengthConstraint: $xaiLengthConstraint, varianceLengthConstraint: $varianceLengthConstraint, matrixGraphLengthConstraint: $matrixGraphLengthConstraint, maxQuotesPerMatrix: $maxQuotesPerMatrix, maxUnmetCriteria: $maxUnmetCriteria, securityPenalty: $securityPenalty, postHocPenalty: $postHocPenalty, passivityPenalty: $passivityPenalty, toneInstruction: $toneInstruction, executiveSummaryDirective: $executiveSummaryDirective, matrix1dSynthesisDirective: $matrix1dSynthesisDirective, matrix2dSynthesisDirective: $matrix2dSynthesisDirective, matrix3dSynthesisDirective: $matrix3dSynthesisDirective, matrixTextSynthesisDirective: $matrixTextSynthesisDirective, rowExplanationDirective: $rowExplanationDirective, xaiSynthesisDirective: $xaiSynthesisDirective, varianceSynthesisDirective: $varianceSynthesisDirective, varianceTargetBlock: $varianceTargetBlock, userRoleTargetBlock: $userRoleTargetBlock, language: $language, matrixSynthesisGroups: $matrixSynthesisGroups, contentBlocks: $contentBlocks, targetBlockOrder: $targetBlockOrder, showSourcesSummaryBox: $showSourcesSummaryBox, sourcesDisplayMode: $sourcesDisplayMode)';
}
...
@useResult
$Res call({
@StrictOpaqueIdConverter() String id, String slug,@StrictOpaqueIdConverter() String workflowId, String? organizationId, I18nText name, I18nText? description,@JsonKey(name: 'user_role_label') I18nText? userRoleLabel,@JsonKey(name: 'custom_preface') I18nText? customPreface, List<String> visibleMetadata,@JsonKey(name: 'matrix_visible_columns') List<String> matrixVisibleColumns, List<XaiExtensionType> visibleBlockExtensions, List<XaiExtensionType> visibleWorkflowExtensions,@JsonKey(name: 'max_extension_items') int maxExtensionItems,@JsonKey(name: 'display_scale') DisplayScale displayScale,@JsonKey(name: 'custom_scale_min') double? customScaleMin,@JsonKey(name: 'custom_scale_max') double? customScaleMax,@JsonKey(name: 'strictness_level') int strictnessLevel,@JsonKey(name: 'synthesis_length_constraint') int? synthesisLengthConstraint,@JsonKey(name: 'row_explanation_length_constraint') int? rowExplanationLengthConstraint,@JsonKey(name: 'xai_length_constraint') int? xaiLengthConstraint,@JsonKey(name: 'variance_length_constraint') int? varianceLengthConstraint,@JsonKey(name: 'matrix_graph_length_constraint') int? matrixGraphLengthConstraint,@JsonKey(name: 'max_quotes_per_matrix') int? maxQuotesPerMatrix,@JsonKey(name: 'max_unmet_criteria') int? maxUnmetCriteria,@JsonKey(name: 'security_penalty') double securityPenalty,@JsonKey(name: 'post_hoc_penalty') double postHocPenalty,@JsonKey(name: 'passivity_penalty') double passivityPenalty,@JsonKey(name: 'tone_instruction') String? toneInstruction,@JsonKey(name: 'executive_summary_directive') String? executiveSummaryDirective,@JsonKey(name: 'matrix_1d_synthesis_directive') String? matrix1dSynthesisDirective,@JsonKey(name: 'matrix_2d_synthesis_directive') String? matrix2dSynthesisDirective,@JsonKey(name: 'matrix_3d_synthesis_directive') String? matrix3dSynthesisDirective,@JsonKey(name: 'matrix_text_synthesis_directive') String? matrixTextSynthesisDirective,@JsonKey(name: 'row_explanation_directive') String? rowExplanationDirective,@JsonKey(name: 'xai_synthesis_directive') String? xaiSynthesisDirective,@JsonKey(name: 'variance_synthesis_directive') String? varianceSynthesisDirective,@JsonKey(name: 'variance_target_block') String? varianceTargetBlock,@JsonKey(name: 'user_role_target_block') String? userRoleTargetBlock, SystemLocale? language,@JsonKey(name: 'matrix_synthesis_groups') List<MatrixSynthesisGroup> matrixSynthesisGroups,@JsonKey(name: 'content_blocks') List<SduiBlockDTO> contentBlocks,@JsonKey(name: 'target_block_order') List<TargetBlockType> targetBlockOrder,@JsonKey(name: 'show_sources_summary_box') bool showSourcesSummaryBox,@JsonKey(name: 'sources_display_mode') SourcesDisplayMode sourcesDisplayMode
});


$I18nTextCopyWith<$Res> get name;$I18nTextCopyWith<$Res>? get description;$I18nTextCopyWith<$Res>? get userRoleLabel;$I18nTextCopyWith<$Res>? get customPreface;
...
/// Create a copy of OutputProfile
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? slug = null,Object? workflowId = null,Object? organizationId = freezed,Object? name = null,Object? description = freezed,Object? userRoleLabel = freezed,Object? customPreface = freezed,Object? visibleMetadata = null,Object? matrixVisibleColumns = null,Object? visibleBlockExtensions = null,Object? visibleWorkflowExtensions = null,Object? maxExtensionItems = null,Object? displayScale = null,Object? customScaleMin = freezed,Object? customScaleMax = freezed,Object? strictnessLevel = null,Object? synthesisLengthConstraint = freezed,Object? rowExplanationLengthConstraint = freezed,Object? xaiLengthConstraint = freezed,Object? varianceLengthConstraint = freezed,Object? matrixGraphLengthConstraint = freezed,Object? maxQuotesPerMatrix = freezed,Object? maxUnmetCriteria = freezed,Object? securityPenalty = null,Object? postHocPenalty = null,Object? passivityPenalty = null,Object? toneInstruction = freezed,Object? executiveSummaryDirective = freezed,Object? matrix1dSynthesisDirective = freezed,Object? matrix2dSynthesisDirective = freezed,Object? matrix3dSynthesisDirective = freezed,Object? matrixTextSynthesisDirective = freezed,Object? rowExplanationDirective = freezed,Object? xaiSynthesisDirective = freezed,Object? varianceSynthesisDirective = freezed,Object? varianceTargetBlock = freezed,Object? userRoleTargetBlock = freezed,Object? language = freezed,Object? matrixSynthesisGroups = null,Object? contentBlocks = null,Object? targetBlockOrder = null,Object? showSourcesSummaryBox = null,Object? sourcesDisplayMode = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
as double?,strictnessLevel: null == strictnessLevel ? _self.strictnessLevel : strictnessLevel // ignore: cast_nullable_to_non_nullable
as int,synthesisLengthConstraint: freezed == synthesisLengthConstraint ? _self.synthesisLengthConstraint : synthesisLengthConstraint // ignore: cast_nullable_to_non_nullable
as int?,rowExplanationLengthConstraint: freezed == rowExplanationLengthConstraint ? _self.rowExplanationLengthConstraint : rowExplanationLengthConstraint // ignore: cast_nullable_to_non_nullable
as int?,xaiLengthConstraint: freezed == xaiLengthConstraint ? _self.xaiLengthConstraint : xaiLengthConstraint // ignore: cast_nullable_to_non_nullable
as int?,varianceLengthConstraint: freezed == varianceLengthConstraint ? _self.varianceLengthConstraint : varianceLengthConstraint // ignore: cast_nullable_to_non_nullable
as int?,matrixGraphLengthConstraint: freezed == matrixGraphLengthConstraint ? _self.matrixGraphLengthConstraint : matrixGraphLengthConstraint // ignore: cast_nullable_to_non_nullable
...
as int?,securityPenalty: null == securityPenalty ? _self.securityPenalty : securityPenalty // ignore: cast_nullable_to_non_nullable
as double,postHocPenalty: null == postHocPenalty ? _self.postHocPenalty : postHocPenalty // ignore: cast_nullable_to_non_nullable
as double,passivityPenalty: null == passivityPenalty ? _self.passivityPenalty : passivityPenalty // ignore: cast_nullable_to_non_nullable
as double,toneInstruction: freezed == toneInstruction ? _self.toneInstruction : toneInstruction // ignore: cast_nullable_to_non_nullable
as String?,executiveSummaryDirective: freezed == executiveSummaryDirective ? _self.executiveSummaryDirective : executiveSummaryDirective // ignore: cast_nullable_to_non_nullable
as String?,matrix1dSynthesisDirective: freezed == matrix1dSynthesisDirective ? _self.matrix1dSynthesisDirective : matrix1dSynthesisDirective // ignore: cast_nullable_to_non_nullable
as String?,matrix2dSynthesisDirective: freezed == matrix2dSynthesisDirective ? _self.matrix2dSynthesisDirective : matrix2dSynthesisDirective // ignore: cast_nullable_to_non_nullable
as String?,matrix3dSynthesisDirective: freezed == matrix3dSynthesisDirective ? _self.matrix3dSynthesisDirective : matrix3dSynthesisDirective // ignore: cast_nullable_to_non_nullable
as String?,matrixTextSynthesisDirective: freezed == matrixTextSynthesisDirective ? _self.matrixTextSynthesisDirective : matrixTextSynthesisDirective // ignore: cast_nullable_to_non_nullable
as String?,rowExplanationDirective: freezed == rowExplanationDirective ? _self.rowExplanationDirective : rowExplanationDirective // ignore: cast_nullable_to_non_nullable
as String?,xaiSynthesisDirective: freezed == xaiSynthesisDirective ? _self.xaiSynthesisDirective : xaiSynthesisDirective // ignore: cast_nullable_to_non_nullable
as String?,varianceSynthesisDirective: freezed == varianceSynthesisDirective ? _self.varianceSynthesisDirective : varianceSynthesisDirective // ignore: cast_nullable_to_non_nullable
as String?,varianceTargetBlock: freezed == varianceTargetBlock ? _self.varianceTargetBlock : varianceTargetBlock // ignore: cast_nullable_to_non_nullable
as String?,userRoleTargetBlock: freezed == userRoleTargetBlock ? _self.userRoleTargetBlock : userRoleTargetBlock // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@StrictOpaqueIdConverter()  String id,  String slug, @StrictOpaqueIdConverter()  String workflowId,  String? organizationId,  I18nText name,  I18nText? description, @JsonKey(name: 'user_role_label')  I18nText? userRoleLabel, @JsonKey(name: 'custom_preface')  I18nText? customPreface,  List<String> visibleMetadata, @JsonKey(name: 'matrix_visible_columns')  List<String> matrixVisibleColumns,  List<XaiExtensionType> visibleBlockExtensions,  List<XaiExtensionType> visibleWorkflowExtensions, @JsonKey(name: 'max_extension_items')  int maxExtensionItems, @JsonKey(name: 'display_scale')  DisplayScale displayScale, @JsonKey(name: 'custom_scale_min')  double? customScaleMin, @JsonKey(name: 'custom_scale_max')  double? customScaleMax, @JsonKey(name: 'strictness_level')  int strictnessLevel, @JsonKey(name: 'synthesis_length_constraint')  int? synthesisLengthConstraint, @JsonKey(name: 'row_explanation_length_constraint')  int? rowExplanationLengthConstraint, @JsonKey(name: 'xai_length_constraint')  int? xaiLengthConstraint, @JsonKey(name: 'variance_length_constraint')  int? varianceLengthConstraint, @JsonKey(name: 'matrix_graph_length_constraint')  int? matrixGraphLengthConstraint, @JsonKey(name: 'max_quotes_per_matrix')  int? maxQuotesPerMatrix, @JsonKey(name: 'max_unmet_criteria')  int? maxUnmetCriteria, @JsonKey(name: 'security_penalty')  double securityPenalty, @JsonKey(name: 'post_hoc_penalty')  double postHocPenalty, @JsonKey(name: 'passivity_penalty')  double passivityPenalty, @JsonKey(name: 'tone_instruction')  String? toneInstruction, @JsonKey(name: 'executive_summary_directive')  String? executiveSummaryDirective, @JsonKey(name: 'matrix_1d_synthesis_directive')  String? matrix1dSynthesisDirective, @JsonKey(name: 'matrix_2d_synthesis_directive')  String? matrix2dSynthesisDirective, @JsonKey(name: 'matrix_3d_synthesis_directive')  String? matrix3dSynthesisDirective, @JsonKey(name: 'matrix_text_synthesis_directive')  String? matrixTextSynthesisDirective, @JsonKey(name: 'row_explanation_directive')  String? rowExplanationDirective, @JsonKey(name: 'xai_synthesis_directive')  String? xaiSynthesisDirective, @JsonKey(name: 'variance_synthesis_directive')  String? varianceSynthesisDirective, @JsonKey(name: 'variance_target_block')  String? varianceTargetBlock, @JsonKey(name: 'user_role_target_block')  String? userRoleTargetBlock,  SystemLocale? language, @JsonKey(name: 'matrix_synthesis_groups')  List<MatrixSynthesisGroup> matrixSynthesisGroups, @JsonKey(name: 'content_blocks')  List<SduiBlockDTO> contentBlocks, @JsonKey(name: 'target_block_order')  List<TargetBlockType> targetBlockOrder, @JsonKey(name: 'show_sources_summary_box')  bool showSourcesSummaryBox, @JsonKey(name: 'sources_display_mode')  SourcesDisplayMode sourcesDisplayMode)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OutputProfile() when $default != null:
return $default(_that.id,_that.slug,_that.workflowId,_that.organizationId,_that.name,_that.description,_that.userRoleLabel,_that.customPreface,_that.visibleMetadata,_that.matrixVisibleColumns,_that.visibleBlockExtensions,_that.visibleWorkflowExtensions,_that.maxExtensionItems,_that.displayScale,_that.customScaleMin,_that.customScaleMax,_that.strictnessLevel,_that.synthesisLengthConstraint,_that.rowExplanationLengthConstraint,_that.xaiLengthConstraint,_that.varianceLengthConstraint,_that.matrixGraphLengthConstraint,_that.maxQuotesPerMatrix,_that.maxUnmetCriteria,_that.securityPenalty,_that.postHocPenalty,_that.passivityPenalty,_that.toneInstruction,_that.executiveSummaryDirective,_that.matrix1dSynthesisDirective,_that.matrix2dSynthesisDirective,_that.matrix3dSynthesisDirective,_that.matrixTextSynthesisDirective,_that.rowExplanationDirective,_that.xaiSynthesisDirective,_that.varianceSynthesisDirective,_that.varianceTargetBlock,_that.userRoleTargetBlock,_that.language,_that.matrixSynthesisGroups,_that.contentBlocks,_that.targetBlockOrder,_that.showSourcesSummaryBox,_that.sourcesDisplayMode);case _:
  return orElse();
...
@override@JsonKey(name: 'row_explanation_length_constraint') final  int? rowExplanationLengthConstraint;
@override@JsonKey(name: 'xai_length_constraint') final  int? xaiLengthConstraint;
@override@JsonKey(name: 'variance_length_constraint') final  int? varianceLengthConstraint;
@override@JsonKey(name: 'matrix_graph_length_constraint') final  int? matrixGraphLengthConstraint;
...
@override@JsonKey(name: 'security_penalty') final  double securityPenalty;
@override@JsonKey(name: 'post_hoc_penalty') final  double postHocPenalty;
@override@JsonKey(name: 'passivity_penalty') final  double passivityPenalty;
@override@JsonKey(name: 'tone_instruction') final  String? toneInstruction;
@override@JsonKey(name: 'executive_summary_directive') final  String? executiveSummaryDirective;
@override@JsonKey(name: 'matrix_1d_synthesis_directive') final  String? matrix1dSynthesisDirective;
@override@JsonKey(name: 'matrix_2d_synthesis_directive') final  String? matrix2dSynthesisDirective;
@override@JsonKey(name: 'matrix_3d_synthesis_directive') final  String? matrix3dSynthesisDirective;
@override@JsonKey(name: 'matrix_text_synthesis_directive') final  String? matrixTextSynthesisDirective;
@override@JsonKey(name: 'row_explanation_directive') final  String? rowExplanationDirective;
@override@JsonKey(name: 'xai_synthesis_directive') final  String? xaiSynthesisDirective;
@override@JsonKey(name: 'variance_synthesis_directive') final  String? varianceSynthesisDirective;
@override@JsonKey(name: 'variance_target_block') final  String? varianceTargetBlock;
@override@JsonKey(name: 'user_role_target_block') final  String? userRoleTargetBlock;
...
@override $I18nTextCopyWith<$Res> get name;@override $I18nTextCopyWith<$Res>? get description;@override $I18nTextCopyWith<$Res>? get userRoleLabel;@override $I18nTextCopyWith<$Res>? get customPreface;
