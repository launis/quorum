...
mixin _$ExpectedInput {
 ...
 String get inputKey; I18nText get label; bool get required; bool get isChatHistory;@JsonKey(name: 'is_endorsed_deliverable') bool get isEndorsedDeliverable; List<String> get inputModes; I18nText get description; bool get scanForPerformativePatterns; String? get aiDescription; List<QuestionnaireItem> get questionnaireDefinition;
...
@override
String toString() {
  return 'ExpectedInput(inputKey: $inputKey, label: $label, required: $required, isChatHistory: $isChatHistory, isEndorsedDeliverable: $isEndorsedDeliverable, inputModes: $inputModes, description: $description, scanForPerformativePatterns: $scanForPerformativePatterns, aiDescription: $aiDescription, questionnaireDefinition: $questionnaireDefinition)';
}
...
@useResult
$Res call({
 String inputKey, I18nText label, bool required, bool isChatHistory,@JsonKey(name: 'is_endorsed_deliverable') bool isEndorsedDeliverable, List<String> inputModes, I18nText description, bool scanForPerformativePatterns, String? aiDescription, List<QuestionnaireItem> questionnaireDefinition
});
...
/// Create a copy of ExpectedInput
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? inputKey = null,Object? label = null,Object? required = null,Object? isChatHistory = null,Object? isEndorsedDeliverable = null,Object? inputModes = null,Object? description = null,Object? scanForPerformativePatterns = null,Object? aiDescription = freezed,Object? questionnaireDefinition = null,}) {
  return _then(_self.copyWith(
...
as bool,isEndorsedDeliverable: null == isEndorsedDeliverable ? _self.isEndorsedDeliverable : isEndorsedDeliverable // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String inputKey,  I18nText label,  bool required,  bool isChatHistory, @JsonKey(name: 'is_endorsed_deliverable')  bool isEndorsedDeliverable,  List<String> inputModes,  I18nText description,  bool scanForPerformativePatterns,  String? aiDescription,  List<QuestionnaireItem> questionnaireDefinition)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ExpectedInput() when $default != null:
return $default(_that.inputKey,_that.label,_that.required,_that.isChatHistory,_that.isEndorsedDeliverable,_that.inputModes,_that.description,_that.scanForPerformativePatterns,_that.aiDescription,_that.questionnaireDefinition);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String inputKey,  I18nText label,  bool required,  bool isChatHistory, @JsonKey(name: 'is_endorsed_deliverable')  bool isEndorsedDeliverable,  List<String> inputModes,  I18nText description,  bool scanForPerformativePatterns,  String? aiDescription,  List<QuestionnaireItem> questionnaireDefinition)  $default,) {final _that = this;
switch (_that) {
case _ExpectedInput():
return $default(_that.inputKey,_that.label,_that.required,_that.isChatHistory,_that.isEndorsedDeliverable,_that.inputModes,_that.description,_that.scanForPerformativePatterns,_that.aiDescription,_that.questionnaireDefinition);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String inputKey,  I18nText label,  bool required,  bool isChatHistory, @JsonKey(name: 'is_endorsed_deliverable')  bool isEndorsedDeliverable,  List<String> inputModes,  I18nText description,  bool scanForPerformativePatterns,  String? aiDescription,  List<QuestionnaireItem> questionnaireDefinition)?  $default,) {final _that = this;
switch (_that) {
case _ExpectedInput() when $default != null:
return $default(_that.inputKey,_that.label,_that.required,_that.isChatHistory,_that.isEndorsedDeliverable,_that.inputModes,_that.description,_that.scanForPerformativePatterns,_that.aiDescription,_that.questionnaireDefinition);case _:
  return null;
...
class _ExpectedInput extends ExpectedInput {
  const _ExpectedInput({required this.inputKey, required this.label, required this.required, this.isChatHistory = false, @JsonKey(name: 'is_endorsed_deliverable') this.isEndorsedDeliverable = false, final  List<String> inputModes = const [], required this.description, this.scanForPerformativePatterns = false, this.aiDescription, final  List<QuestionnaireItem> questionnaireDefinition = const []}): _inputModes = inputModes,_questionnaireDefinition = questionnaireDefinition,super._();
...
@override@JsonKey(name: 'is_endorsed_deliverable') final  bool isEndorsedDeliverable;
...
/// Create a copy of ExpectedInput
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? inputKey = null,Object? label = null,Object? required = null,Object? isChatHistory = null,Object? isEndorsedDeliverable = null,Object? inputModes = null,Object? description = null,Object? scanForPerformativePatterns = null,Object? aiDescription = freezed,Object? questionnaireDefinition = null,}) {
...
@StrictOpaqueIdConverter() String get id;@StrictOpaqueIdConverter() String get taskBlueprint; List<String> get dependsOn; Map<String, String> get inputMappings;@JsonKey(name: 'expected_sdui_type') SduiBlockType? get expectedSduiType; double get uiPosX; double get uiPosY;// Phase 1, Step 3: Synthesis context governance field
@JsonKey(name: 'is_synthesis_source') bool get isSynthesisSource;
...
@override
String toString() {
  return 'StepRule(id: $id, taskBlueprint: $taskBlueprint, dependsOn: $dependsOn, inputMappings: $inputMappings, expectedSduiType: $expectedSduiType, uiPosX: $uiPosX, uiPosY: $uiPosY, isSynthesisSource: $isSynthesisSource)';
}
...
@useResult
$Res call({
@StrictOpaqueIdConverter() String id,@StrictOpaqueIdConverter() String taskBlueprint, List<String> dependsOn, Map<String, String> inputMappings,@JsonKey(name: 'expected_sdui_type') SduiBlockType? expectedSduiType, double uiPosX, double uiPosY,@JsonKey(name: 'is_synthesis_source') bool isSynthesisSource
});
...
/// Create a copy of StepRule
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? taskBlueprint = null,Object? dependsOn = null,Object? inputMappings = null,Object? expectedSduiType = freezed,Object? uiPosX = null,Object? uiPosY = null,Object? isSynthesisSource = null,}) {
  return _then(_self.copyWith(
...
as double,isSynthesisSource: null == isSynthesisSource ? _self.isSynthesisSource : isSynthesisSource // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@StrictOpaqueIdConverter()  String id, @StrictOpaqueIdConverter()  String taskBlueprint,  List<String> dependsOn,  Map<String, String> inputMappings, @JsonKey(name: 'expected_sdui_type')  SduiBlockType? expectedSduiType,  double uiPosX,  double uiPosY, @JsonKey(name: 'is_synthesis_source')  bool isSynthesisSource)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _StepRule() when $default != null:
return $default(_that.id,_that.taskBlueprint,_that.dependsOn,_that.inputMappings,_that.expectedSduiType,_that.uiPosX,_that.uiPosY,_that.isSynthesisSource);case _:
  return orElse();
...
@override@JsonKey(name: 'is_synthesis_source') final  bool isSynthesisSource;
...
/// Create a copy of StepRule
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? taskBlueprint = null,Object? dependsOn = null,Object? inputMappings = null,Object? expectedSduiType = freezed,Object? uiPosX = null,Object? uiPosY = null,Object? isSynthesisSource = null,}) {
...
@StrictOpaqueIdConverter() String get id; String get slug; I18nText get name; I18nText get description; String get status; int get version; bool get isPublic; String? get organizationId; Map<String, OutputProfile> get outputProfiles; String get defaultProfileId;@JsonKey(name: 'mcp_gateway_id') String? get mcpGatewayId;@JsonKey(name: 'model_registry_id') String get modelRegistryId;@JsonKey(name: 'default_strictness_level') int get defaultStrictnessLevel;@JsonKey(name: 'security_penalty') double get securityPenalty;@JsonKey(name: 'post_hoc_penalty') double get postHocPenalty;@JsonKey(name: 'passivity_penalty') double get passivityPenalty;@JsonKey(name: 'enable_contextual_overrides') bool get enableContextualOverrides;@JsonKey(name: 'enable_semantic_smoothing') bool get enableSemanticSmoothing;@JsonKey(name: 'enable_eager_anonymization') bool get enableEagerAnonymization;@JsonKey(name: 'system_audit_trail') bool get systemAuditTrail;@JsonKey(name: 'historical_context_mode') String get historicalContextMode; List<ExpectedInput> get expectedInputs; List<StepRule> get steps;
...
@override
String toString() {
  return 'Workflow(id: $id, slug: $slug, name: $name, description: $description, status: $status, version: $version, isPublic: $isPublic, organizationId: $organizationId, outputProfiles: $outputProfiles, defaultProfileId: $defaultProfileId, mcpGatewayId: $mcpGatewayId, modelRegistryId: $modelRegistryId, defaultStrictnessLevel: $defaultStrictnessLevel, securityPenalty: $securityPenalty, postHocPenalty: $postHocPenalty, passivityPenalty: $passivityPenalty, enableContextualOverrides: $enableContextualOverrides, enableSemanticSmoothing: $enableSemanticSmoothing, enableEagerAnonymization: $enableEagerAnonymization, systemAuditTrail: $systemAuditTrail, historicalContextMode: $historicalContextMode, expectedInputs: $expectedInputs, steps: $steps)';
}
...
@useResult
$Res call({
@StrictOpaqueIdConverter() String id, String slug, I18nText name, I18nText description, String status, int version, bool isPublic, String? organizationId, Map<String, OutputProfile> outputProfiles, String defaultProfileId,@JsonKey(name: 'mcp_gateway_id') String? mcpGatewayId,@JsonKey(name: 'model_registry_id') String modelRegistryId,@JsonKey(name: 'default_strictness_level') int defaultStrictnessLevel,@JsonKey(name: 'security_penalty') double securityPenalty,@JsonKey(name: 'post_hoc_penalty') double postHocPenalty,@JsonKey(name: 'passivity_penalty') double passivityPenalty,@JsonKey(name: 'enable_contextual_overrides') bool enableContextualOverrides,@JsonKey(name: 'enable_semantic_smoothing') bool enableSemanticSmoothing,@JsonKey(name: 'enable_eager_anonymization') bool enableEagerAnonymization,@JsonKey(name: 'system_audit_trail') bool systemAuditTrail,@JsonKey(name: 'historical_context_mode') String historicalContextMode, List<ExpectedInput> expectedInputs, List<StepRule> steps
});
...
/// Create a copy of Workflow
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? slug = null,Object? name = null,Object? description = null,Object? status = null,Object? version = null,Object? isPublic = null,Object? organizationId = freezed,Object? outputProfiles = null,Object? defaultProfileId = null,Object? mcpGatewayId = freezed,Object? modelRegistryId = null,Object? defaultStrictnessLevel = null,Object? securityPenalty = null,Object? postHocPenalty = null,Object? passivityPenalty = null,Object? enableContextualOverrides = null,Object? enableSemanticSmoothing = null,Object? enableEagerAnonymization = null,Object? systemAuditTrail = null,Object? historicalContextMode = null,Object? expectedInputs = null,Object? steps = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,slug: null == slug ? _self.slug : slug // ignore: cast_nullable_to_non_nullable
as String,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
...
as String?,modelRegistryId: null == modelRegistryId ? _self.modelRegistryId : modelRegistryId // ignore: cast_nullable_to_non_nullable
...
as double,enableContextualOverrides: null == enableContextualOverrides ? _self.enableContextualOverrides : enableContextualOverrides // ignore: cast_nullable_to_non_nullable
...
as bool,historicalContextMode: null == historicalContextMode ? _self.historicalContextMode : historicalContextMode // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _Workflow() when $default != null:
return $default(_that.id,_that.slug,_that.name,_that.description,_that.status,_that.version,_that.isPublic,_that.organizationId,_that.outputProfiles,_that.defaultProfileId,_that.mcpGatewayId,_that.modelRegistryId,_that.defaultStrictnessLevel,_that.securityPenalty,_that.postHocPenalty,_that.passivityPenalty,_that.enableContextualOverrides,_that.enableSemanticSmoothing,_that.enableEagerAnonymization,_that.systemAuditTrail,_that.historicalContextMode,_that.expectedInputs,_that.steps);case _:
  return orElse();
...
class _Workflow extends Workflow {
  const _Workflow({@StrictOpaqueIdConverter() required this.id, required this.slug, required this.name, required this.description, this.status = "draft", this.version = 1, this.isPublic = false, this.organizationId, final  Map<String, OutputProfile> outputProfiles = const {}, this.defaultProfileId = "default", @JsonKey(name: 'mcp_gateway_id') this.mcpGatewayId = "sys_8172bda70c8641c5", @JsonKey(name: 'model_registry_id') required this.modelRegistryId, @JsonKey(name: 'default_strictness_level') this.defaultStrictnessLevel = 50, @JsonKey(name: 'security_penalty') this.securityPenalty = 0.0, @JsonKey(name: 'post_hoc_penalty') this.postHocPenalty = 0.0, @JsonKey(name: 'passivity_penalty') this.passivityPenalty = 0.0, @JsonKey(name: 'enable_contextual_overrides') this.enableContextualOverrides = false, @JsonKey(name: 'enable_semantic_smoothing') this.enableSemanticSmoothing = false, @JsonKey(name: 'enable_eager_anonymization') this.enableEagerAnonymization = false, @JsonKey(name: 'system_audit_trail') this.systemAuditTrail = false, @JsonKey(name: 'historical_context_mode') this.historicalContextMode = 'DISABLED', final  List<ExpectedInput> expectedInputs = const [], final  List<StepRule> steps = const []}): _outputProfiles = outputProfiles,_expectedInputs = expectedInputs,_steps = steps,super._();
...
@override@JsonKey(name: 'mcp_gateway_id') final  String? mcpGatewayId;
...
/// Create a copy of Workflow
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? slug = null,Object? name = null,Object? description = null,Object? status = null,Object? version = null,Object? isPublic = null,Object? organizationId = freezed,Object? outputProfiles = null,Object? defaultProfileId = null,Object? mcpGatewayId = freezed,Object? modelRegistryId = null,Object? defaultStrictnessLevel = null,Object? securityPenalty = null,Object? postHocPenalty = null,Object? passivityPenalty = null,Object? enableContextualOverrides = null,Object? enableSemanticSmoothing = null,Object? enableEagerAnonymization = null,Object? systemAuditTrail = null,Object? historicalContextMode = null,Object? expectedInputs = null,Object? steps = null,}) {
