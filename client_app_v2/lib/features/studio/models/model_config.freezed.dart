...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,provider,modelName,temperature,maxTokens,parsingMode,topP,topK,tpmLimit,rpmLimit,supportsGrounding,isActive,const DeepCollectionEquality().hash(allowedTools),apiKey,cachingStrategy,const DeepCollectionEquality().hash(additionalParams));

@override
String toString() {
  return 'LlmModelConfig(provider: $provider, modelName: $modelName, temperature: $temperature, maxTokens: $maxTokens, parsingMode: $parsingMode, topP: $topP, topK: $topK, tpmLimit: $tpmLimit, rpmLimit: $rpmLimit, supportsGrounding: $supportsGrounding, isActive: $isActive, allowedTools: $allowedTools, apiKey: $apiKey, cachingStrategy: $cachingStrategy, additionalParams: $additionalParams)';
}
...
switch (_that) {
case _LlmModelConfig() when $default != null:
return $default(_that.provider,_that.modelName,_that.temperature,_that.maxTokens,_that.parsingMode,_that.topP,_that.topK,_that.tpmLimit,_that.rpmLimit,_that.supportsGrounding,_that.isActive,_that.allowedTools,_that.apiKey,_that.cachingStrategy,_that.additionalParams);case _:
  return orElse();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,provider,modelName,temperature,maxTokens,parsingMode,topP,topK,tpmLimit,rpmLimit,supportsGrounding,isActive,const DeepCollectionEquality().hash(_allowedTools),apiKey,cachingStrategy,const DeepCollectionEquality().hash(_additionalParams));
