...
_OutputProfile _$OutputProfileFromJson(
  ...
  ($checkedConvert) {
    $checkKeys(
      ...
      allowedKeys: const [
        ...
        'matrix_graph_length_constraint',
    ...
    final val = _OutputProfile(
      ...
      matrixGraphLengthConstraint: $checkedConvert(
        'matrix_graph_length_constraint',
        (v) => (v as num?)?.toInt(),
      ),
      ...
      varianceTargetBlock: $checkedConvert(
        'variance_target_block',
        (v) => v as String?,
      ),
  ...
  fieldKeyMap: const {
    ...
    'matrixGraphLengthConstraint': 'matrix_graph_length_constraint',
...
Map<String, dynamic> _$OutputProfileToJson(
  ...
  'matrix_graph_length_constraint': instance.matrixGraphLengthConstraint,
