...
/// A 2D Quadrant Matrix chart specifically visualizing Variance and Authenticity Evaluation
/// with 4 diagnostic background quadrants and localized watermark titles.
class QuadrantMatrixChart extends StatelessWidget {
  const QuadrantMatrixChart({
    super.key,
    required this.xAxis,
    required this.yAxis,
    this.zAxis,
