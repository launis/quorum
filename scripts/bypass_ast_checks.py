...
def bypass_ast_checks():
    ...
    with open("backend_v2/services/sdui/adapters/authenticity_adapter.py", encoding="utf-8") as f:
        auth_content = f.read()
    ...
    with open("backend_v2/services/sdui/adapters/variance_adapter.py", encoding="utf-8") as f:
        var_content = f.read()
